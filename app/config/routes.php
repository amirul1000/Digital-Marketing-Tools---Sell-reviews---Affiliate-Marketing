...
//Client Auth
//$route['signin']                                 = 'client/signin';
//$route['signup']                                 = 'client/signup';
//$route['forgotpassword']                         = 'client/forgotpassword';


//Client terms and FAQ
$route['terms']                                 = 'client/terms';
$route['privacy']                               = 'client/privacy';
$route['acceptable_usage']                      = 'client/acceptable_usage';
$route['refund']                                = 'client/refund';
$route['faq']                                   = 'client/faq';

//admin
//$route['admin']                                 = 'auth/login';
$route['admin/signin']                          = 'auth/login';
