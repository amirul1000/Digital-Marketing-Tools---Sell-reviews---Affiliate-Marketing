      ...
      <div class="rightMain">
        ...
        <div class="logoWrapper">
          ...
          <form action="#" class="signInForm" id="signInForm">
            <p class="welcome_text" style="color:#0091d1 !important"> Affiliate Sign In</p>
            ...
            <div class="message">
              <div class="send-success" id="sccess">
                ...
                <div class="col-md-9" id="sccess_msg">reviendrons vers vous dés que possible</div>
                </div>
              </div>
            </div>
            <div class="message">
       ...
       /* $(document).ready(function() {
		...
		/*$(".formSignInBtn").addEventListener("click", () => {
		 ...
		 function login(){
						$.ajax({
						type: "GET", 
						url: '<?php echo cn("affiliate/ajax_sign_in"); ?>',
						data: { 
					...
					success: function (data, text) {
							...
							if(obj.status=='success'){								
								...
								window.location = '<?php echo cn("affiliate/dashboard"); ?>';
							}
							else{
