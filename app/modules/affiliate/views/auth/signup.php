...
<div class="wrapperLeft" style="height: auto !important;">
          ...
          <div class="rightMain signUp">
            <div class="wrapperRight">
              ...
              <form action="" class="signInForm" onSubmit="return false;">
                <p class="welcome_text" style="color:#0091d1 !important">Affiliate Sign Up</p>
	  ...
	  function signup(){
		    $.ajax({
						type: "GET", 
						url: '<?php echo cn("affiliate/ajax_sign_up"); ?>',
						data: { 
					...
					success: function (data, text) {
						   console.log(data);
							...
							if(obj.status=='success'){
								 ...
								 window.location = '<?php echo cn("affiliate/signin"); ?>';
							}
							else{
							   alert(obj.status+":"+obj.message);	
							}
