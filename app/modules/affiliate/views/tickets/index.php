          ...
          <table class="table table-hover table-bordered table-vcenter card-table">
            ...
            <tbody>
              ...
              <tr class="tr_<?php echo strip_tags($row->ids); ?>">
                ...
                <td><?php echo convert_timezone($row->created, "admin", '', 'date'); ?></td>
                <td><?php echo convert_timezone($row->created, "admin", '', 'time'); ?></td>
                <td> <!--class="text-nowrap"-->
                    <span>IP:<?php echo strip_tags($row->ip); ?>
                    <?php if (!empty($row->ip)) { ?>
                    <?php echo get_ip_location($row->ip) ." ". get_ip_flag($row->ip); ?>
                    <?php } ?></span>
                </td>
