...
<aside class="navbar navbar-side navbar-fixed js-sidebar" id="aside">
  ...
  <div class="mobile-logo">
    ...
    <a href="<?php echo cn('client/dashboard'); ?>" class="navbar-brand text-inherit">
...
?></span>-->
    ...
    'Dashboard'
      ...
      <!--<li class="nav-item">
        ...
        <a class="nav-link text-white <?php if (segment(2) == 'users') {
            echo 'active';
        } else {
            echo '';
        } ?>" href="<?php echo cn(
...
?></span>-->
      ...
      <!--</h6>-->
        ...
        <a class="nav-link text-white <?php if (segment(2) == 'checkout') {
            echo 'active';
        } else {
            echo '';
        } ?>" href="<?php echo cn(
