            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="projectinput5"><?php echo lang('title'); ?> <span class="form-required">*</span></label>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label for="bloginput8"><?php echo lang('description'); ?> <span class="form-required">*</span></label>
