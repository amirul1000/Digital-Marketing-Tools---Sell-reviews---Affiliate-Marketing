...
class category extends MX_Controller {
	...
	public function ajax_update($ids = ""){
		...
		if ($type != "cms") {
    		...
    		$isRequireActive 		= (int)post("is_require_link_active");
    		...
    		$data = array(
    			...
    			"is_require_link_active"       => $isRequireActive,
    			"options"                      => $options,
    		);
    		...
    		$buyus 		            = $this->input->post('buyus', false);
    		$howitworks             = $this->input->post('howitworks', false);
    		$testimonials           = $this->input->post('testimonials', false);
    		$features 		        = $this->input->post('features', false);
    		
    		$buyus 		            = json_encode($buyus);
