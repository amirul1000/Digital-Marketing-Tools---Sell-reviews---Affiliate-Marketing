                        ...
                        <div class="row">
                          <div class="col-md-2">
                            <div class="input-group" style="width:unset">
                                <input type="text" name="buyus[0][icon]" class="form-control mb-0" value="">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <input type="text" name="buyus[0][topic]" class="form-control" value="Price for 1 Google Maps Review" readonly>
                          </div>
                          <div class="col-md-1">
                            <input type="text" name="buyus[0][topreviewagency]" class="form-control" value="3$">
                          </div>
                          <div class="col-md-1">
                            <input type="text" name="buyus[0][logo1]" class="form-control" value="7.5$">
                          </div>
                          <div class="col-md-1">
                            <input type="text" name="buyus[0][logo2]" class="form-control" value="7.25$">
                          </div>
                          <div class="col-md-1">
                            <input type="text" name="buyus[0][logo3]" class="form-control" value="25$">
                          </div>
                          <div class="col-md-1">
                            <input type="text" name="buyus[0][logo4]" class="form-control" value="25$">
                          </div>
                          <div class="col-md-1">
                            <input type="text" name="buyus[0][logo5]" class="form-control" value="25$">
                          </div>
                          <div class="col-md-1 text-center">
                          </div>
                        </div>
                ...
                <div class="form-group-item">
                  ...
                  <div class="g-items">
                    <div class="item" data-number="0">
                      <div class="row">
                        <div class="col-md-5">
                          <input type="text" name="testimonials[0][title]" class="form-control" placeholder="Eg: Sofia Chan">
                        </div>
                        <div class="col-md-6">
                          <textarea name="testimonials[0][content]" class="form-control full-h" placeholder="..."></textarea>
                        </div>
                        <div class="col-md-1 text-center">
                            <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                        </div>
