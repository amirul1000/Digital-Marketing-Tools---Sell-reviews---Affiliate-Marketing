...
class sales_model extends MY_Model {
	...
	function get_order_logs_list($total_rows = false, $status = "", $limit = "", $start = ""){
		...
		$this->db->select('o.*, u.email as user_email, u.first_name, u.last_name, u.civility, u.company, u.address, u.city, u.country, s.name as service_name, api.name as api_name');
