    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header bg-pantone">
            <h4 class="modal-title"><i class="fe fe-eye"></i> <?php echo ('View Ticket') ." ". get_format_id($ticket->created, $ticket->id); ?></h4>
        ...
        <div class="modal-footer">
          <button type="button" class="btn bg-blue-theme-active mr-1 mb-1 text-white" data-dismiss="modal"><?=lang("Close")?></button>
        </div>
      </div>
    </div>
  </div>
