<div class="page-header d-md-none">
  <h1 class="page-title">
    <i class="icon fe fe-users" aria-hidden="true"></i> <?php echo lang(
        'Customers'
    ); ?>
  </h1>
</div>
  ...
  <div class="col-md-12 col-xl-12">
    ...
    strtotime($row->created)
              ...
              <td><span> <!--class="text-nowrap"-->
                  <?php echo 'IP: ' . strip_tags($row->history_ip); ?>
                  <?php echo get_ip_location(
                      $row->history_ip
                  )."". get_ip_flag($row->history_ip); ?></span>
              </td>
              ...
              <td><?php echo strip_tags($row->address) .
                  ' ' .
                  strip_tags($row->postal_code) .
                  ' ' .
                  strip_tags($row->city) .
                  ' ' .
                  strip_tags($row->country); ?></td>
              <td class="text-center"><?php echo strip_tags(
                  $row->total_orders
              ); ?></td>
