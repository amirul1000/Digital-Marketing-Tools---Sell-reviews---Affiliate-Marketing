...
setInterval(() => {
  if (index == 4) index = 1;
  const ac = document.querySelector(`.car-${index}`);
  const bu = document.querySelector(`.bullet-container-bullet-${index}`);
