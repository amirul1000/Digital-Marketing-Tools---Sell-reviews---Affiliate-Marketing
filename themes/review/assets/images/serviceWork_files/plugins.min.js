...
!(function (t, e) {
  ...
  function l(t, e, i) {
    ...
    if (void 0 === i && 1 === t.nodeType)
      if (
        ((s = "data-" + e.replace(_t, "-$1").toLowerCase()),
        (i = t.getAttribute(s)),
        "string" == typeof i)
      ) {
        try {
  ...
  function g(t, e) {
    ...
    if (1 === e.nodeType) {
      if (
        vt.hasData(t) &&
        ((a = vt.access(t)), (o = vt.set(e, a)), (h = a.events))
      ) {
        delete o.handle, (o.events = {});
        for (n in h)
          for (i = 0, s = h[n].length; s > i; i++) J.event.add(e, n, h[n][i]);
      }
      yt.hasData(t) &&
        ((r = yt.access(t)), (l = J.extend({}, r)), yt.set(e, l));
    }
  }
  function v(t, e) {
  ...
  function b(e, i) {
    var s,
      n = J(i.createElement(e)).appendTo(i.body),
      a =
        t.getDefaultComputedStyle && (s = t.getDefaultComputedStyle(n[0]))
          ? s.display
          : J.css(n[0], "display");
    return n.detach(), a;
  }
  function _(t) {
    ...
    return (
      i ||
        ...
        ("none" !== i && i) ||
          ((Rt = (
            Rt || J("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function C(t, e) {
    if (e in t) return e;
    for (var i = e[0].toUpperCase() + e.slice(1), s = e, n = Ut.length; n--; )
      if (((e = Ut[n] + i), e in t)) return e;
    return s;
  }
  function T(t, e, i) {
    var s = Vt.exec(e);
  ...
  function k(t, e, i, s, n) {
    for (
      var a = i === (s ? "border" : "content") ? 4 : "width" === e ? 1 : 0,
        o = 0;
      4 > a;
      a += 2
    )
      "margin" === i && (o += J.css(t, i + xt[a], !0, n)),
        s
          ? ("content" === i && (o -= J.css(t, "padding" + xt[a], !0, n)),
            "margin" !== i &&
              (o -= J.css(t, "border" + xt[a] + "Width", !0, n)))
          : ((o += J.css(t, "padding" + xt[a], !0, n)),
            "padding" !== i &&
              (o += J.css(t, "border" + xt[a] + "Width", !0, n)));
    return o;
  }
  function S(t, e, i) {
    var s = !0,
      ...
      a = jt(t),
      o = "border-box" === J.css(t, "boxSizing", !1, a);
    if (0 >= n || null == n) {
      if (
        ((n = w(t, e, a)), (0 > n || null == n) && (n = t.style[e]), qt.test(n))
      )
        return n;
      (s = o && (K.boxSizingReliable() || n === t.style[e])),
        (n = parseFloat(n) || 0);
    }
    return n + k(t, e, i || (o ? "border" : "content"), s, a) + "px";
  }
  function D(t, e) {
    for (var i, s, n, a = [], o = 0, r = t.length; r > o; o++)
      (s = t[o]),
        s.style &&
          ((a[o] = vt.get(s, "olddisplay")),
          (i = s.style.display),
          e
            ? (a[o] || "none" !== i || (s.style.display = ""),
              "" === s.style.display &&
                Ct(s) &&
                (a[o] = vt.access(s, "olddisplay", _(s.nodeName))))
            : ((n = Ct(s)),
              ("none" === i && n) ||
                vt.set(s, "olddisplay", n ? i : J.css(s, "display"))));
    for (o = 0; r > o; o++)
      (s = t[o]),
        s.style &&
          ((e && "none" !== s.style.display && "" !== s.style.display) ||
            (s.style.display = e ? a[o] || "" : "none"));
    return t;
  }
  function M(t, e, i, s, n) {
    return new M.prototype.init(t, e, i, s, n);
  }
  function I() {
    return (
      setTimeout(function () {
  ...
  function P(t, e) {
    ...
    for (e = e ? 1 : 0; 4 > s; s += 2 - e)
      (i = xt[s]), (n["margin" + i] = n["padding" + i] = t);
    return e && (n.opacity = n.width = t), n;
  }
  function z(t, e, i) {
    for (
      var s, n = (ie[e] || []).concat(ie["*"]), a = 0, o = n.length;
      o > a;
      a++
    )
  ...
  function E(t, e, i) {
    ...
    i.queue ||
      ...
      1 === t.nodeType &&
        ...
        (h = J.css(t, "display")),
        (u = "none" === h ? vt.get(t, "olddisplay") || _(t.nodeName) : h),
        "inline" === u &&
          "none" === J.css(t, "float") &&
    ...
    for (s in e)
      if (((n = e[s]), Zt.exec(n))) {
        if (
          (delete e[s], (a = a || "toggle" === n), n === (f ? "hide" : "show"))
        ) {
          if ("show" !== n || !m || void 0 === m[s]) continue;
          f = !0;
        }
        d[s] = (m && m[s]) || J.style(t, s);
      } else h = void 0;
  ...
  function A(t, e) {
    ...
    for (i in t)
      if (
        ...
        (n = e[s]),
        (a = t[i]),
        J.isArray(a) && ((n = a[1]), (a = t[i] = a[0])),
        i !== s && ((t[s] = a), delete t[i]),
        (o = J.cssHooks[s]),
        o && "expand" in o)
      ) {
        (a = o.expand(a)), delete t[s];
        for (i in a) i in t || ((t[i] = a[i]), (e[i] = n));
      } else e[s] = n;
  }
  function N(t, e, i) {
    var s,
      ...
      l = function () {
        ...
        for (
          ...
          h.tweens[o].run(a);
        return (
          r.notifyWith(t, [h, a, i]),
          1 > a && l ? i : (r.resolveWith(t, [h]), !1)
        );
      },
      h = r.promise({
        elem: t,
      ...
      u = h.props;
    for (A(u, h.opts.specialEasing); o > a; a++)
      if ((s = ee[a].call(h, t, u, h.opts))) return s;
    return (
      J.map(u, z, h),
  ...
  function O(t, e, i, s) {
    function n(r) {
      ...
      return (
        (a[r] = !0),
        J.each(t[r] || [], function (t, r) {
          var h = r(e, i, s);
          return "string" != typeof h || o || a[h]
            ? o
              ? !(l = h)
              : void 0
    ...
    var a = {},
      o = t === we;
    return n(e.dataTypes[0]) || (!a["*"] && n("*"));
  }
  function L(t, e) {
    var i,
      s,
      n = J.ajaxSettings.flatOptions || {};
    for (i in e) void 0 !== e[i] && ((n[i] ? t : s || (s = {}))[i] = e[i]);
    return s && J.extend(!0, t, s), t;
  }
  function W(t, e, i) {
    for (var s, n, a, o, r = t.contents, l = t.dataTypes; "*" === l[0]; )
      l.shift(),
        ...
        if ("*" === a) a = l;
          ...
          if (((o = h[l + " " + a] || h["* " + a]), !o))
            for (n in h)
              if (
                ((r = n.split(" ")),
                r[1] === a && (o = h[l + " " + r[0]] || h["* " + r[0]]))
              ) {
                o === !0
                  ? (o = h[n])
                  : h[n] !== !0 && ((a = r[0]), u.unshift(r[1]));
                break;
              }
          if (o !== !0)
            if (o && t["throws"]) e = o(e);
  ...
  function F(t, e, i, s) {
    ...
    if (J.isArray(e))
      J.each(e, function (e, n) {
        i || ke.test(t)
          ? s(t, n)
          : F(t + "[" + ("object" == typeof n ? e : "") + "]", n, i, s);
      });
    else if (i || "object" !== J.type(e)) s(t, e);
    else for (n in e) F(t + "[" + n + "]", e[n], i, s);
  }
  function B(t) {
    ...
    (J.extend = J.fn.extend =
      function () {
        var t,
          ...
          h = !1;
        for (
          "boolean" == typeof o && ((h = o), (o = arguments[r] || {}), r++),
          ...
          if (null != (t = arguments[r]))
            for (e in t)
              (i = o[e]),
                (s = t[e]),
                o !== s &&
                  (h && s && (J.isPlainObject(s) || (n = J.isArray(s)))
                    ? (n
                        ? ((n = !1), (a = i && J.isArray(i) ? i : []))
                        : (a = i && J.isPlainObject(i) ? i : {}),
                      (o[e] = J.extend(h, a, s)))
                    : void 0 !== s && (o[e] = s));
        return o;
      }),
    J.extend({
      ...
      each: function (t, e, s) {
        var n,
          ...
          r = i(t);
        if (s) {
          if (r) for (; o > a && ((n = e.apply(t[a], s)), n !== !1); a++);
          else for (a in t) if (((n = e.apply(t[a], s)), n === !1)) break;
        } else if (r)
          for (; o > a && ((n = e.call(t[a], a, t[a])), n !== !1); a++);
        else for (a in t) if (((n = e.call(t[a], a, t[a])), n === !1)) break;
        return t;
      },
      trim: function (t) {
      ...
      grep: function (t, e, i) {
        for (var s, n = [], a = 0, o = t.length, r = !i; o > a; a++)
          (s = !e(t[a], a)), s !== r && n.push(t[a]);
        return n;
      },
      map: function (t, e, s) {
        var n,
          ...
          r = i(t),
          l = [];
        if (r) for (; o > a; a++) (n = e(t[a], a, s)), null != n && l.push(n);
        else for (a in t) (n = e(t[a], a, s)), null != n && l.push(n);
        return Y.apply([], l);
      },
      guid: 1,
      proxy: function (t, e) {
        ...
        return (
          ...
          J.isFunction(t)
            ? ((s = j.call(arguments, 2)),
              (n = function () {
                return t.apply(e || this, s.concat(j.call(arguments)));
              }),
  ...
  var nt = (function (t) {
    function e(t, e, i, s) {
      var n, a, o, r, l, h, c, p, f, m;
      if (
        ((e ? e.ownerDocument || e : F) !== E && z(e),
        (e = e || E),
        (i = i || []),
        !t || "string" != typeof t)
      )
        ...
        if ((n = yt.exec(t)))
          if ((o = n[1])) {
            if (9 === r) {
              ...
              e.ownerDocument &&
              (a = e.ownerDocument.getElementById(o)) &&
              W(e, a) &&
              a.id === o
            )
              return i.push(a), i;
          } else {
            if (n[2]) return J.apply(i, e.getElementsByTagName(t)), i;
            if (
              (o = n[3]) &&
        ...
        if (w.qsa && (!H || !H.test(t))) {
          if (
            ...
            for (
              ...
              h[l] = p + d(h[l]);
            (f = (bt.test(t) && u(e.parentNode)) || e), (m = h.join(","));
          }
          if (m)
            try {
    ...
    function a(t, e) {
      for (var i = t.split("|"), s = t.length; s--; ) x.attrHandle[i[s]] = e;
    }
    function o(t, e) {
      var i = e && t,
        s =
    ...
    function h(t) {
      return s(function (e) {
        return (
          (e = +e),
          s(function (i, s) {
            for (var n, a = t([], i.length, e), o = a.length; o--; )
              i[(n = a[o])] && (i[n] = !(s[n] = i[n]));
          })
        );
      });
    ...
    function p(t, e, i) {
      ...
      return e.first
        ? function (e, i, a) {
            for (; (e = e[s]); ) if (1 === e.nodeType || n) return t(e, i, a);
          }
        : function (e, i, o) {
            var r,
              l,
            ...
            if (o) {
              for (; (e = e[s]); )
                if ((1 === e.nodeType || n) && t(e, i, o)) return !0;
            } else
              for (; (e = e[s]); )
                if (1 === e.nodeType || n) {
                  if (
    ...
    function m(t, i, s) {
      for (var n = 0, a = i.length; a > n; n++) e(t, i[n], s);
      return s;
    }
    function g(t, e, i, s, n) {
      for (var a, o = [], r = 0, l = t.length, h = null != e; l > r; r++)
        (a = t[r]) && (!i || i(a, s, n)) && (o.push(a), h && e.push(r));
      return o;
    }
      ...
      return (
        ...
        s(function (s, o, r, l) {
          var h,
            ...
            p = [],
            f = o.length,
            v = s || m(e || "*", r.nodeType ? [r] : r, []),
            y = !t || (!s && e) ? v : g(v, d, t, r, l),
            b = i ? (a || (s ? t : f || n) ? [] : o) : y;
          if ((i && i(y, b, r, l), n))
            for (h = g(b, p), n(h, [], r, l), u = h.length; u--; )
              (c = h[u]) && (b[p[u]] = !(y[p[u]] = c));
          if (s) {
            if (a || t) {
              if (a) {
      ...
      var n = i.length > 0,
        ...
        o = function (s, o, r, l, h) {
          var u,
            ...
            w = b.length;
          for (h && (M = o !== E && o); f !== w && null != (u = b[f]); f++) {
            if (a && u) {
              for (c = 0; (d = t[c++]); )
                if (d(u, o, r)) {
                  l.push(u);
            ...
            n && ((u = !d && u) && p--, s && m.push(u));
          }
          if (((p += f), n && f !== p)) {
            for (c = 0; (d = i[c++]); ) d(m, v, o, r);
            if (s) {
              if (p > 0) for (; f--; ) m[f] || v[f] || (v[f] = Q.call(l));
              v = g(v);
            }
            J.apply(l, v),
              h && !s && v.length > 0 && p + i.length > 1 && e.uniqueSort(l);
          }
          return h && ((B = _), (M = y)), m;
        };
      return n ? s(o) : o;
    ...
    var _,
      ...
      bt = /[+~]/,
      _t = /'|\\/g,
      wt = new RegExp("\\\\([\\da-f]{1,6}" + st + "?|(" + st + ")|.)", "ig"),
      xt = function (t, e, i) {
        var s = "0x" + e - 65536;
        return s !== s || i
          ? e
    ...
    try {
      J.apply((K = tt.call(F.childNodes)), F.childNodes),
    ...
    (w = e.support = {}),
        ...
        function (t) {
          ...
          return i !== E && 9 === i.nodeType && i.documentElement
            ? ((E = i),
              ...
              (w.getById = n(function (t) {
                return (
                  (A.appendChild(t).id = R),
              ...
              (x.find.CLASS =
                w.getElementsByClassName &&
                function (t, e) {
                  return typeof e.getElementsByClassName !== $ && N
                    ...
                    return s
                      ...
                      : ((s =
                          (t.ownerDocument || t) === (e.ownerDocument || e)
                            ...
                            : 1),
                        1 & s ||
                        (!w.sortDetached && e.compareDocumentPosition(t) === s)
                          ? t === i || (t.ownerDocument === F && W(F, t))
                            ? -1
                            : e === i || (e.ownerDocument === F && W(F, e))
                            ? 1
                            : I
                            ? et.call(I, t) - et.call(I, e)
                            : 0
                          : 4 & s
                          ? -1
                          : 1);
      ...
      (e.matchesSelector = function (t, i) {
        if (
          ((t.ownerDocument || t) !== E && z(t),
          (i = i.replace(ct, "='$1']")),
          !(!w.matchesSelector || !N || (O && O.test(i)) || (H && H.test(i))))
        )
          try {
            var s = L.call(t, i);
            if (
      ...
      (e.contains = function (t, e) {
        return (t.ownerDocument || t) !== E && z(t), W(t, e);
      }),
      (e.attr = function (t, e) {
        (t.ownerDocument || t) !== E && z(t);
        var i = x.attrHandle[e.toLowerCase()],
          s = i && U.call(x.attrHandle, e.toLowerCase()) ? i(t, e, !N) : void 0;
        return void 0 !== s
          ? s
          : w.attributes || !N
          ? t.getAttribute(e)
      ...
      (x = e.selectors =
        {
                ...
                return null == a
                  ...
                  : !i ||
                      ...
                      "=" === i
                        ...
                        ? s && a.indexOf(s) > -1
                        : "$=" === i
                        ? s && a.slice(-s.length) === s
                        : "~=" === i
                        ? (" " + a + " ").indexOf(s) > -1
                        : "|=" === i &&
                          (a === s || a.slice(0, s.length + 1) === s + "-"));
              };
            },
              ...
              return a[R]
                ...
                ? ((n = [t, t, "", i]),
                  x.setFilters.hasOwnProperty(t.toLowerCase())
                    ? s(function (t, e) {
                        for (var s, n = a(t, i), o = n.length; o--; )
                          (s = et.call(t, n[o])), (t[s] = !(e[s] = n[o]));
                      })
                    : function (t) {
                        return a(t, 0, n);
                      })
          ...
          pseudos: {
            not: s(function (t) {
              ...
              return n[R]
                ? s(function (t, e, i, s) {
                    for (var a, o = n(t, null, s, []), r = t.length; r--; )
                      (a = o[r]) && (t[r] = !(e[r] = a));
                  })
                : function (t, s, a) {
      ...
      (k = e.tokenize =
        function (t, i) {
          ...
          for (r = t, l = [], h = x.preFilter; r; ) {
            (!s || (n = ht.exec(r))) &&
              (n && (r = r.slice(n[0].length) || r), l.push((a = []))),
              (s = !1),
              (n = ut.exec(r)) &&
                ((s = n.shift()),
                a.push({ value: s, type: n[0].replace(lt, " ") }),
                (r = r.slice(s.length)));
            for (o in x.filter)
              !(n = ft[o].exec(r)) ||
                (h[o] && !(n = h[o](n))) ||
                ((s = n.shift()),
                a.push({ value: s, type: o, matches: n }),
                (r = r.slice(s.length)));
            if (!s) break;
          }
        ...
        function (t, e) {
          ...
          if (!a) {
            for (e || (e = k(t)), i = e.length; i--; )
              (a = y(e[i])), a[R] ? s.push(a) : n.push(a);
            (a = V(t, b(n, s))), (a.selector = t);
          }
          return a;
        }),
      (D = e.select =
        function (t, e, i, s) {
          ...
          if (((i = i || []), 1 === c.length)) {
            if (
              ...
              if (
                ((e = (x.find.ID(o.matches[0].replace(wt, xt), e) || [])[0]),
                !e)
              )
                return i;
            ...
            for (
              n = ft.needsContext.test(t) ? 0 : a.length;
              n-- && ((o = a[n]), !x.relative[(r = o.type)]);
              ...
              if (
                ...
                (s = l(
                  ...
                  (bt.test(a[0].type) && u(e.parentNode)) || e
                ))
              ) {
                if ((a.splice(n, 1), (t = s.length && d(a)), !t))
                  return J.apply(i, s), i;
                break;
              }
          }
          return (
            (h || S(t, c))(s, e, !N, i, (bt.test(t) && u(e.parentNode)) || e), i
          );
        }),
      (w.sortStable = R.split("").sort(X).join("") === R),
      (w.detectDuplicates = !!P),
      z(),
      (w.sortDetached = n(function (t) {
    ...
    J.fn.extend({
      find: function (t) {
        ...
        if ("string" != typeof t)
          return this.pushStack(
            J(t).filter(function () {
              for (e = 0; i > e; e++) if (J.contains(n[e], this)) return !0;
            })
          );
        for (e = 0; i > e; e++) J.find(t, n[e], s);
        return (
          (s = this.pushStack(i > 1 ? J.unique(s) : s)),
          (s.selector = this.selector ? this.selector + " " + t : t),
          s
        );
      },
      filter: function (t) {
      ...
      is: function (t) {
        return !!s(
          this,
          "string" == typeof t && at.test(t) ? J(t) : t || [],
          !1
        ).length;
      },
    });
      ...
      if ("string" == typeof t) {
        ...
        if (i[1]) {
          if (
            ...
            J.merge(
              this,
              J.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : Q, !0)
            ),
      ...
      closest: function (t, e) {
        for (
          var i,
            ...
            a = [],
            o =
              at.test(t) || "string" != typeof t ? J(t, e || this.context) : 0;
          n > s;
          s++
        )
    ...
    J.each(
      ...
      function (t, e) {
        J.fn[t] = function (i, s) {
          ...
          return (
            "Until" !== t.slice(-5) && (s = i),
            s && "string" == typeof s && (n = J.filter(s, n)),
            this.length > 1 &&
              (dt[t] || J.unique(n), ct.test(t) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (J.Callbacks = function (t) {
    t = "string" == typeof t ? ft[t] || a(t) : J.extend({}, t);
    var e,
      i,
      s,
      n,
      ...
      u = function (a) {
        for (
          e = t.memory && a, i = !0, r = n || 0, n = 0, o = l.length, s = !0;
          l && o > r;
          r++
        )
        ...
        (s = !1),
          l && (h ? h.length && u(h.shift()) : e ? (l = []) : c.disable());
      },
      c = {
        add: function () {
          if (l) {
            ...
            !(function a(e) {
              J.each(e, function (e, i) {
                ...
                "function" === s
                  ...
                  : i && i.length && "string" !== s && a(i);
              });
            })(arguments),
              s ? (o = l.length) : e && ((n = i), u(e));
          }
          return this;
        },
        remove: function () {
    ...
    J.extend({
      ...
      when: function (t) {
        var e,
          ...
          a = j.call(arguments),
          o = a.length,
          r = 1 !== o || (t && J.isFunction(t.promise)) ? o : 0,
          l = 1 === r ? t : J.Deferred(),
          h = function (t, i, s) {
            return function (n) {
              (i[t] = this),
                (s[t] = arguments.length > 1 ? j.call(arguments) : n),
                s === e ? l.notifyWith(i, s) : --r || l.resolveWith(i, s);
            };
          };
        if (o > 1)
          for (e = new Array(o), i = new Array(o), s = new Array(o); o > n; n++)
            a[n] && J.isFunction(a[n].promise)
              ? a[n]
                  .promise()
                  .done(h(n, s, a))
                  .fail(l.reject)
                  .progress(h(n, i, e))
              : --r;
        return r || l.resolveWith(s, a), l.promise();
      },
    });
  var mt;
      ...
      return (
        mt ||
          ...
          "complete" === Q.readyState
            ? setTimeout(J.ready)
            : (Q.addEventListener("DOMContentLoaded", o, !1),
              t.addEventListener("load", o, !1))),
        mt.promise(e)
      );
    }),
    J.ready.promise();
  var gt = (J.access = function (t, e, i, s, n, a, o) {
    var r = 0,
      l = t.length,
      h = null == i;
    if ("object" === J.type(i)) {
      n = !0;
      for (r in i) J.access(t, e, r, i[r], !0, a, o);
    } else if (
      void 0 !== s &&
      ((n = !0),
      J.isFunction(s) || (o = !0),
      ...
      for (; l > r; r++) e(t[r], i, o ? s : s.call(t[r], r, e(t[r], i)));
    return n ? t : h ? e.call(t) : l ? e(t[0], i) : a;
  });
  (J.acceptData = function (t) {
    return 1 === t.nodeType || 9 === t.nodeType || !+t.nodeType;
  }),
    (r.uid = 1),
    (r.accepts = J.acceptData),
    (r.prototype = {
      key: function (t) {
      ...
      set: function (t, e, i) {
        ...
        else if (J.isEmptyObject(a)) J.extend(this.cache[n], e);
        else for (s in e) a[s] = e[s];
        return a;
      },
      get: function (t, e) {
      ...
      access: function (t, e, i) {
        ...
        return void 0 === e || (e && "string" == typeof e && void 0 === i)
          ? ((s = this.get(t, e)),
            void 0 !== s ? s : this.get(t, J.camelCase(e)))
      ...
      remove: function (t, e) {
        ...
        if (void 0 === e) this.cache[a] = {};
          ...
          J.isArray(e)
            ? (s = e.concat(e.map(J.camelCase)))
            : ((n = J.camelCase(e)),
              e in o
                ? (s = [e, n])
                : ((s = n), (s = s in o ? [s] : s.match(pt) || []))),
            (i = s.length);
          for (; i--; ) delete o[s[i]];
        }
      },
    ...
    J.fn.extend({
      data: function (t, e) {
        ...
        if (void 0 === t) {
          if (
            this.length &&
            ((n = yt.get(a)), 1 === a.nodeType && !vt.get(a, "hasDataAttrs"))
          ) {
            for (i = o.length; i--; )
              o[i] &&
                ((s = o[i].name),
                0 === s.indexOf("data-") &&
                  ((s = J.camelCase(s.slice(5))), l(a, s, n[s])));
          ...
          : gt(
              ...
              function (e) {
                var i,
                  s = J.camelCase(t);
                if (a && void 0 === e) {
                  if (((i = yt.get(a, t)), void 0 !== i)) return i;
                  if (((i = yt.get(a, s)), void 0 !== i)) return i;
                  if (((i = l(a, s, void 0)), void 0 !== i)) return i;
                } else
                  this.each(function () {
                    var i = yt.get(this, s);
                    yt.set(this, s, e),
    ...
    J.fn.extend({
      ...
      promise: function (t, e) {
        ...
        for (
          ...
          (i = vt.get(a[o], t + "queueHooks")),
            i && i.empty && (s++, i.empty.add(r));
  ...
  (J.event = {
    ...
    add: function (t, e, i, s, n) {
      ...
      if (g)
        for (
          i.handler && ((a = i), (i = a.handler), (n = a.selector)),
          ...
          (r = It.exec(e[h]) || []),
            ...
            p &&
              ...
              (d = l[p]) ||
                ((d = l[p] = []),
                (d.delegateCount = 0),
                (c.setup && c.setup.call(t, s, f, o) !== !1) ||
        ...
        for (e = (e || "").match(pt) || [""], h = e.length; h--; )
          if (
            ...
            o &&
              ...
              delete l[p]);
          } else for (p in l) J.event.remove(t, p + e[h], i, s, !0);
    ...
    trigger: function (e, i, s, n) {
      ...
      if (
        ...
        3 !== s.nodeType &&
          ...
          (c = J.event.special[p] || {}),
          n || !c.trigger || c.trigger.apply(s, i) !== !1))
      ) {
        if (!n && !c.noBubble && !J.isWindow(s)) {
          for (
            l = c.delegateType || p, Mt.test(l + p) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            d.push(o), (r = o);
        ...
        for (a = 0; (o = d[a++]) && !e.isPropagationStopped(); )
          (e.type = a > 1 ? l : c.bindType || p),
            (u = (vt.get(o, "events") || {})[e.type] && vt.get(o, "handle")),
            u && u.apply(o, i),
            (u = h && o[h]),
            u &&
              u.apply &&
              J.acceptData(o) &&
              ((e.result = u.apply(o, i)),
    ...
    dispatch: function (t) {
      ...
      if (
        ...
        for (
          ...
          (n = o[e++]) && !t.isPropagationStopped();

        )
          for (
            t.currentTarget = n.elem, i = 0;
            (a = n.handlers[i++]) && !t.isImmediatePropagationStopped();
    ...
    fix: function (t) {
      ...
      for (
        o ||
          (this.fixHooks[n] = o =
            Dt.test(n) ? this.mouseHooks : St.test(n) ? this.keyHooks : {}),
    ...
    simulate: function (t, e, i, s) {
      ...
      s ? J.event.trigger(n, null, e) : J.event.dispatch.call(e, n),
        ...
        J.event.special[e] = {
          setup: function () {
            var s = this.ownerDocument || this,
              n = vt.access(s, e);
            n || s.addEventListener(t, i, !0), vt.access(s, e, (n || 0) + 1);
          },
          teardown: function () {
            var s = this.ownerDocument || this,
              n = vt.access(s, e) - 1;
            n
              ? vt.access(s, e, n)
              : (s.removeEventListener(t, i, !0), vt.remove(s, e));
          },
        };
      }),
    J.fn.extend({
      on: function (t, e, i, s, n) {
        ...
        return (
          1 === n &&
            ...
            (s.guid = a.guid || (a.guid = J.guid++))),
          this.each(function () {
            J.event.add(this, t, s, i, e);
          })
        );
      },
  ...
  (Wt.optgroup = Wt.option),
    ...
    J.extend({
      clone: function (t, e, i) {
        ...
        if (
          ...
          for (o = v(r), a = v(t), s = 0, n = a.length; n > s; s++)
            y(a[s], o[s]);
        if (e)
          if (i)
            for (a = a || v(t), o = o || v(r), s = 0, n = a.length; n > s; s++)
              g(a[s], o[s]);
          else g(t, r);
        return (
          (o = v(r, "script")), o.length > 0 && m(o, !l && v(t, "script")), r
        );
      },
      buildFragment: function (t, e, i, s) {
        for (
          ...
          if (((n = t[d]), n || 0 === n))
            if ("object" === J.type(n)) J.merge(c, n.nodeType ? [n] : n);
            else if (Et.test(n)) {
              for (
                a = a || u.appendChild(e.createElement("div")),
                  o = (zt.exec(n) || ["", ""])[1].toLowerCase(),
                  r = Wt[o] || Wt._default,
                  a.innerHTML = r[1] + n.replace(Pt, "<$1></$2>") + r[2],
                  h = r[0];
                h--;

              )
                a = a.lastChild;
              J.merge(c, a.childNodes),
                (a = u.firstChild),
                (a.textContent = "");
            } else c.push(e.createTextNode(n));
        for (u.textContent = "", d = 0; (n = c[d++]); )
          if (
            (!s || -1 === J.inArray(n, s)) &&
            ((l = J.contains(n.ownerDocument, n)),
            (a = v(u.appendChild(n), "script")),
            l && m(a),
            i)
          )
            for (h = 0; (n = a[h++]); ) Ht.test(n.type || "") && i.push(n);
        return u;
      },
      cleanData: function (t) {
        for (
          var e, i, s, n, a = J.event.special, o = 0;
          void 0 !== (i = t[o]);
          o++
        ) {
          if (
            J.acceptData(i) &&
            ((n = i[vt.expando]), n && (e = vt.cache[n]))
          ) {
            if (e.events)
              for (s in e.events)
                a[s] ? J.event.remove(i, s) : J.removeEvent(i, s, e.handle);
            vt.cache[n] && delete vt.cache[n];
          }
    ...
    J.fn.extend({
      ...
      remove: function (t, e) {
        for (
          var i, s = t ? J.filter(t, this) : this, n = 0;
          null != (i = s[n]);
          n++
        )
      ...
      domManip: function (t, e) {
        ...
        var i,
          ...
          d = t[0],
          m = J.isFunction(d);
        if (m || (h > 1 && "string" == typeof d && !K.checkClone && Nt.test(d)))
          return this.each(function (i) {
            var s = u.eq(i);
            m && (t[0] = d.call(this, i, s.html())), s.domManip(t, e);
          });
        if (
          h &&
          ...
          for (n = J.map(v(i, "script"), p), a = n.length; h > l; l++)
            (o = i),
              l !== c &&
                ((o = J.clone(o, !0, !0)), a && J.merge(n, v(o, "script"))),
              e.call(this[l], o, l);
          if (a)
            for (
              r = n[n.length - 1].ownerDocument, J.map(n, f), l = 0;
              a > l;
              l++
            )
              (o = n[l]),
                Ht.test(o.type || "") &&
                  !vt.access(o, "globalEval") &&
                  J.contains(r, o) &&
                  (o.src
                    ? J._evalUrl && J._evalUrl(o.src)
                    : J.globalEval(o.textContent.replace(Lt, "")));
        }
        return this;
      },
    }),
    J.each(
      ...
      function (t, e) {
        J.fn[t] = function (t) {
          for (var i, s = [], n = J(t), a = n.length - 1, o = 0; a >= o; o++)
  ...
  !(function () {
    function e() {
      ...
      (i = "1%" !== e.top), (s = "4px" === e.width), n.removeChild(a);
    }
    var i,
      s,
      n = Q.documentElement,
    ...
    o.style &&
      ...
      (K.clearCloneStyle = "content-box" === o.style.backgroundClip),
      (a.style.cssText =
      ...
      t.getComputedStyle &&
        J.extend(K, {
          ...
          reliableMarginRight: function () {
            var e,
              i = o.appendChild(Q.createElement("div"));
            return (
  ...
  J.extend({
    ...
    style: function (t, e, i, s) {
      if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
        var n,
          ...
          l = t.style;
        return (
          (e = J.cssProps[r] || (J.cssProps[r] = C(l, r))),
          (o = J.cssHooks[e] || J.cssHooks[r]),
          void 0 === i
            ? o && "get" in o && void 0 !== (n = o.get(t, !1, s))
              ? n
              : l[e]
            : ((a = typeof i),
              "string" === a &&
                (n = Xt.exec(i)) &&
                ((i = (n[1] + 1) * n[2] + parseFloat(J.css(t, e))),
                (a = "number")),
              void (
                null != i &&
                i === i &&
                ("number" !== a || J.cssNumber[r] || (i += "px"),
                K.clearCloneStyle ||
                  "" !== i ||
                  0 !== e.indexOf("background") ||
                  (l[e] = "inherit"),
                (o && "set" in o && void 0 === (i = o.set(t, i, s))) ||
                  (l[e] = i))
              ))
        );
      }
    ...
    css: function (t, e, i, s) {
      var n,
        ...
        r = J.camelCase(e);
      return (
        (e = J.cssProps[r] || (J.cssProps[r] = C(t.style, r))),
        (o = J.cssHooks[e] || J.cssHooks[r]),
        o && "get" in o && (n = o.get(t, !0, i)),
        void 0 === n && (n = w(t, e, s)),
        "normal" === n && e in Gt && (n = Gt[e]),
        "" === i || i
          ? ((a = parseFloat(n)), i === !0 || J.isNumeric(a) ? a || 0 : n)
          : n
      );
    },
  }),
    J.each(["height", "width"], function (t, e) {
      J.cssHooks[e] = {
        get: function (t, i, s) {
          return i
            ? Yt.test(J.css(t, "display")) && 0 === t.offsetWidth
              ? J.swap(t, $t, function () {
                  return S(t, e, s);
                })
              : S(t, e, s)
        ...
        set: function (t, i, s) {
          ...
          return T(
            t,
            i,
            s ? k(t, e, s, "border-box" === J.css(t, "boxSizing", !1, n), n) : 0
          );
        },
      };
    }),
      ...
      (J.cssHooks[t + e] = {
        expand: function (i) {
          for (
            ...
            n[t + xt[s] + e] = a[s] || a[s - 2] || a[0];
          return n;
        },
      }),
        Bt.test(t) || (J.cssHooks[t + e].set = T);
    }),
    J.fn.extend({
      css: function (t, e) {
        return gt(
          ...
          function (t, e, i) {
            var s,
              ...
              o = 0;
            if (J.isArray(e)) {
              for (s = jt(t), n = e.length; n > o; o++)
                a[e[o]] = J.css(t, e[o], !1, s);
              return a;
            }
      ...
      "*": [
        function (t, e) {
          var i = this.createTween(t, e),
            s = i.cur(),
            n = Jt.exec(e),
            a = (n && n[3]) || (J.cssNumber[t] ? "" : "px"),
            o =
              (J.cssNumber[t] || ("px" !== a && +s)) &&
              Jt.exec(J.css(i.elem, t)),
            r = 1,
            l = 20;
          if (o && o[3] !== a) {
            (a = a || o[3]), (n = n || []), (o = +s || 1);
            do (r = r || ".5"), (o /= r), J.style(i.elem, t, o + a);
  ...
  (J.Animation = J.extend(N, {
    tweener: function (t, e) {
      ...
      for (var i, s = 0, n = t.length; n > s; s++)
        (i = t[s]), (ie[i] = ie[i] || []), ie[i].unshift(e);
    },
    ...
    (J.speed = function (t, e, i) {
      ...
      return (
        (s.duration = J.fx.off
          ...
          ? s.duration
          : s.duration in J.fx.speeds
          ? J.fx.speeds[s.duration]
          : J.fx.speeds._default),
        (null == s.queue || s.queue === !0) && (s.queue = "fx"),
        (s.old = s.complete),
        (s.complete = function () {
          J.isFunction(s.old) && s.old.call(this),
            s.queue && J.dequeue(this, s.queue);
        }),
        s
      );
    }),
    J.fn.extend({
      ...
      animate: function (t, e, i, s) {
        var n = J.isEmptyObject(t),
          a = J.speed(e, i, s),
          o = function () {
            var e = N(this, J.extend({}, t), a);
            (n || vt.get(this, "finish")) && e.stop(!0);
          };
        return (
          (o.finish = o),
          n || a.queue === !1 ? this.each(o) : this.queue(a.queue, o)
        );
      },
      stop: function (t, e, i) {
        var s = function (t) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (n in o) o[n] && o[n].stop && te.test(n) && s(o[n]);
            for (n = a.length; n--; )
              a[n].elem !== this ||
                (null != t && a[n].queue !== t) ||
                (a[n].anim.stop(i), (e = !1), a.splice(n, 1));
    ...
    J.each(["toggle", "show", "hide"], function (t, e) {
      var i = J.fn[e];
      J.fn[e] = function (t, s, n) {
        return null == t || "boolean" == typeof t
          ? i.apply(this, arguments)
          : this.animate(P(e, !0), t, s, n);
      };
    }),
    J.each(
      {
    ...
    J.extend({
      attr: function (t, e, i) {
        ...
        if (t && 3 !== a && 8 !== a && 2 !== a)
          return typeof t.getAttribute === kt
            ...
            : ((1 === a && J.isXMLDoc(t)) ||
                ((e = e.toLowerCase()),
                (s = J.attrHooks[e] || (J.expr.match.bool.test(e) ? ne : se))),
              void 0 === i
                ? s && "get" in s && null !== (n = s.get(t, e))
                  ? n
                  : ((n = J.find.attr(t, e)), null == n ? void 0 : n)
                : null !== i
      ...
      removeAttr: function (t, e) {
        ...
        if (a && 1 === t.nodeType)
          for (; (i = a[n++]); )
            (s = J.propFix[i] || i),
              J.expr.match.bool.test(i) && (t[s] = !1),
              t.removeAttribute(i);
      },
      attrHooks: {
        type: {
      ...
      ae[e] = function (t, e, s) {
        ...
        return (
          s ||
            ((a = ae[e]),
            (ae[e] = n),
            (n = null != i(t, e, s) ? e.toLowerCase() : null),
            (ae[e] = a)),
          n
        );
      };
    ...
    J.extend({
      ...
      prop: function (t, e, i) {
        ...
        if (t && 3 !== o && 8 !== o && 2 !== o)
          return (
            (a = 1 !== o || !J.isXMLDoc(t)),
            a && ((e = J.propFix[e] || e), (n = J.propHooks[e])),
            void 0 !== i
  ...
  J.fn.extend({
      ...
      if (r)
        for (e = (t || "").match(pt) || []; h > l; l++)
          if (
            ...
            (s =
              1 === i.nodeType &&
              (i.className ? (" " + i.className + " ").replace(re, " ") : " ")))
          ) {
            for (a = 0; (n = e[a++]); )
              s.indexOf(" " + n + " ") < 0 && (s += n + " ");
            (o = J.trim(s)), i.className !== o && (i.className = o);
          }
      return this;
    },
        ...
        for (e = (t || "").match(pt) || []; h > l; l++)
          if (
            ...
            for (a = 0; (n = e[a++]); )
              for (; s.indexOf(" " + n + " ") >= 0; )
                s = s.replace(" " + n + " ", " ");
            (o = t ? J.trim(s) : ""), i.className !== o && (i.className = o);
          }
      return this;
    },
        ...
        : this.each(
            J.isFunction(t)
              ...
              : function () {
                  if ("string" === i)
                    for (
                      var e, s = 0, n = J(this), a = t.match(pt) || [];
                      (e = a[s++]);
    ...
    hasClass: function (t) {
      for (var e = " " + t + " ", i = 0, s = this.length; s > i; i++)
        if (
          1 === this[i].nodeType &&
          (" " + this[i].className + " ").replace(re, " ").indexOf(e) >= 0
        )
          return !0;
      return !1;
    },
      ...
      return arguments.length
        ? ((s = J.isFunction(t)),
          this.each(function (i) {
            var n;
            1 === this.nodeType &&
              ((n = s ? t.call(this, i, J(this).val()) : t),
              null == n
                ? (n = "")
                : "number" == typeof n
                ? (n += "")
        ...
        : n
        ? ((e = J.valHooks[n.type] || J.valHooks[n.nodeName.toLowerCase()]),
    ...
    J.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (t, e) {
            for (
              var i, s, n = t.options, a = J.makeArray(e), o = n.length;
              o--;

            )
              (s = n[o]), (s.selected = J.inArray(s.value, a) >= 0) && (i = !0);
  ...
  (ce = be.exec(de.toLowerCase()) || []),
      ...
      ajax: function (t, e) {
        function i(t, e, i, o) {
          ...
          2 !== b &&
            ...
            (w.status = t),
            (w.statusText = (e || x) + ""),
            l ? f.resolveWith(d, [u, x, w]) : f.rejectWith(d, [w, x, v]),
            w.statusCode(g),
            (g = void 0),
            h && p.trigger(l ? "ajaxSuccess" : "ajaxError", [w, c, l ? u : v]),
            m.fireWith(d, [w, x]),
            h &&
        ...
        var s,
          ...
          c = J.ajaxSetup({}, e),
          d = c.context || c,
          p = c.context && (d.nodeType || d.jquery) ? J(d) : J.event,
          f = J.Deferred(),
        ...
        (h = c.global),
          ...
          (c.hasContent = !ve.test(c.type)),
          (n = c.url),
          c.hasContent ||
            (c.data &&
              ((n = c.url += (ue.test(n) ? "&" : "?") + c.data), delete c.data),
            c.cache === !1 &&
              (c.url = fe.test(n)
                ? n.replace(fe, "$1_=" + he++)
                : n + (ue.test(n) ? "&" : "?") + "_=" + he++)),
          c.ifModified &&
            (J.lastModified[n] &&
              w.setRequestHeader("If-Modified-Since", J.lastModified[n]),
            J.etag[n] && w.setRequestHeader("If-None-Match", J.etag[n])),
        ...
        if (c.beforeSend && (c.beforeSend.call(d, w, c) === !1 || 2 === b))
          return w.abort();
        _ = "abort";
        for (u in { success: 1, error: 1, complete: 1 }) w[u](c[u]);
        if ((s = O(we, c, e, w))) {
          (w.readyState = 1),
            h && p.trigger("ajaxSend", [w, c]),
            c.async &&
              c.timeout > 0 &&
    ...
    J.each(["get", "post"], function (t, e) {
      J[e] = function (t, i, s, n) {
        return (
          J.isFunction(i) && ((n = n || s), (s = i), (i = void 0)),
          J.ajax({ url: t, type: e, dataType: n, data: i, success: s })
        );
      };
    }),
    J.each(
  ...
  (J.param = function (t, e) {
    ...
    else for (i in t) F(i, t[i], e, n);
    return s.join("&").replace(Te, "+");
  }),
    J.fn.extend({
      serialize: function () {
  ...
  var Ie = 0,
    Pe = {},
    ze = { 0: 200, 1223: 204 },
    Ee = J.ajaxSettings.xhr();
  t.ActiveXObject &&
    J(t).on("unload", function () {
      for (var t in Pe) Pe[t]();
    }),
    (K.cors = !!Ee && "withCredentials" in Ee),
    (K.ajax = Ee = !!Ee),
    J.ajaxTransport(function (t) {
      var e;
      return K.cors || (Ee && !t.crossDomain)
        ? {
            send: function (i, s) {
              var n,
                a = t.xhr(),
              ...
              if (
                ...
                for (n in t.xhrFields) a[n] = t.xhrFields[n];
              t.mimeType &&
                a.overrideMimeType &&
              ...
              for (n in i) a.setRequestHeader(n, i[n]);
              (e = function (t) {
                return function () {
                  e &&
                    (delete Pe[o],
  ...
  J.ajaxSetup({
    ...
    jsonpCallback: function () {
      var t = Ae.pop() || J.expando + "_" + he++;
      return (this[t] = !0), t;
    },
  }),
    J.ajaxPrefilter("json jsonp", function (e, i, s) {
      var n,
        a,
        o,
        r =
      ...
      return r || "jsonp" === e.dataTypes[0]
        ? ((n = e.jsonpCallback =
            J.isFunction(e.jsonpCallback)
              ...
              : e.jsonpCallback),
          r
            ? (e[r] = e[r].replace(Ne, "$1" + n))
            : e.jsonp !== !1 &&
              (e.url += (ue.test(e.url) ? "&" : "?") + e.jsonp + "=" + n),
          (e.converters["script json"] = function () {
            return o || J.error(n + " was not called"), o[0];
          }),
          (e.dataTypes[0] = "json"),
          (a = t[n]),
          (t[n] = function () {
          ...
          s.always(function () {
            (t[n] = a),
              e[n] && ((e.jsonpCallback = i.jsonpCallback), Ae.push(n)),
    ...
    (J.parseHTML = function (t, e, i) {
      ...
      return s
        ? [e.createElement(s[1])]
        : ((s = J.buildFragment([t], e, n)),
          n && n.length && J(n).remove(),
          J.merge([], s.childNodes));
    });
  var He = J.fn.load;
  (J.fn.load = function (t, e, i) {
    ...
    var s,
      ...
      r = t.indexOf(" ");
    return (
      r >= 0 && ((s = J.trim(t.slice(r))), (t = t.slice(0, r))),
      J.isFunction(e)
        ? ((i = e), (e = void 0))
        : e && "object" == typeof e && (n = "POST"),
      o.length > 0 &&
        J.ajax({ url: t, type: n, dataType: "html", data: e })
          .done(function (t) {
            (a = arguments),
              o.html(s ? J("<div>").append(J.parseHTML(t)).find(s) : t);
          })
          .complete(
            i &&
              function (t, e) {
  ...
  (J.offset = {
    setOffset: function (t, e, i) {
      ...
      "static" === u && (t.style.position = "relative"),
        ...
        h
          ? ((s = c.position()), (o = s.top), (n = s.left))
          : ((o = parseFloat(a) || 0), (n = parseFloat(l) || 0)),
        J.isFunction(e) && (e = e.call(t, i, r)),
        null != e.top && (d.top = e.top - r.top + o),
        null != e.left && (d.left = e.left - r.left + n),
    ...
    J.fn.extend({
      offset: function (t) {
        ...
        return a
          ? ((e = a.documentElement),
            J.contains(e, s)
              ? (typeof s.getBoundingClientRect !== kt &&
        ...
        if (this[0]) {
          ...
          return (
            "fixed" === J.css(i, "position")
              ...
              : ((t = this.offsetParent()),
                (e = this.offset()),
                J.nodeName(t[0], "html") || (s = t.offset()),
                (s.top += J.css(t[0], "borderTopWidth", !0)),
                (s.left += J.css(t[0], "borderLeftWidth", !0))),
            {
              top: e.top - s.top - J.css(i, "marginTop", !0),
              left: e.left - s.left - J.css(i, "marginLeft", !0),
            }
          );
        }
      },
            ...
            function (e, n, a) {
              ...
              return void 0 === a
                ? o
                  ...
                  : e[n]
                : void (o
                    ? o.scrollTo(s ? t.pageXOffset : a, s ? a : t.pageYOffset)
                    : (e[n] = a));
            },
            e,
            n,
    ...
    J.each(["top", "left"], function (t, e) {
      J.cssHooks[e] = x(K.pixelPosition, function (t, i) {
        return i
          ? ((i = w(t, e)), qt.test(i) ? J(t).position()[e] + "px" : i)
          : void 0;
      });
    }),
  ...
  return (
    (J.noConflict = function (e) {
      return t.$ === J && (t.$ = We), e && t.jQuery === J && (t.jQuery = Le), J;
    }),
    ...
    function e(e) {
      return this.each(function () {
        var s = t(this),
          n = s.data("bs.affix"),
          a = "object" == typeof e && e;
        n || s.data("bs.affix", (n = new i(this, a))),
          "string" == typeof e && n[e]();
      });
    }
    var i = function (e, s) {
   ...
   * ======================================================================== */ +(function (
    ...
    function i(e) {
      return this.each(function () {
        ...
        !n && a.toggle && /show|hide/.test(e) && (a.toggle = !1),
          n || i.data("bs.collapse", (n = new s(this, a))),
          "string" == typeof e && n[e]();
      });
    }
    var s = function (e, i) {
  ...
  (function (t, e) {
    ...
    var s = function (t, e, i, s, n, a) {
      for (
        var o = 0, r = ["webkit", "moz", "ms", "o"], l = 0;
        l < r.length && !window.requestAnimationFrame;
        ++l
      )
        (window.requestAnimationFrame = window[r[l] + "RequestAnimationFrame"]),
          (window.cancelAnimationFrame =
            window[r[l] + "CancelAnimationFrame"] ||
            window[r[l] + "CancelRequestAnimationFrame"]);
      ...
      "" === h.options.separator && (h.options.useGrouping = !1),
        ...
        (h.formatNumber = function (t) {
          ...
          if (
            ((e = t.split(".")),
            (i = e[0]),
            (s = e.length > 1 ? h.options.decimal + e[1] : ""),
            (n = /(\d+)(\d{3})/),
            h.options.useGrouping)
          )
            for (; n.test(i); )
              i = i.replace(n, "$1" + h.options.separator + "$2");
          return h.options.prefix + i + s + h.options.suffix;
        }),
        (h.easeOutExpo = function (t, e, i, s) {
          return (i * (-Math.pow(2, (-10 * t) / s) + 1) * 1024) / 1023 + e;
        }),
   ...
   * Copyright jQuery Foundation and other contributors; Licensed MIT */ (function (
    ...
    (t.cleanData = (function (e) {
      ...
      (t.widget.extend = function (e) {
        for (
          var i, s, n = h.call(arguments, 1), a = 0, o = n.length;
          o > a;
          a++
        )
          for (i in n[a])
            ...
            return (
              ...
              this.each(function () {
                var s,
                  ...
                  T = u + v + i(this, "marginBottom") + _.height,
                  k = t.extend({}, g),
                  S = e(x.my, l.outerWidth(), l.outerHeight());
                "right" === n.my[0]
                  ? (k.left -= h)
                  : "center" === n.my[0] && (k.left -= h / 2),
                  "bottom" === n.my[1]
                    ? (k.top -= u)
                    : "center" === n.my[1] && (k.top -= u / 2),
                  (k.left += S[0]),
                  (k.top += S[1]),
                  ...
                  n.using &&
                    (r = function (t) {
                      ...
                      h > p && p > o(e + i) && (c.horizontal = "center"),
                        u > f && f > o(s + r) && (c.vertical = "middle"),
                        (c.important =
                          a(o(e), o(i)) > a(o(s), o(r))
                            ? "horizontal"
                            : "vertical"),
            ...
            flip: {
              ...
              top: function (t, e) {
                var i,
                  ...
                  m = -2 * e.offset[1];
                0 > u
                  ? ((s = t.top + p + f + m + e.collisionHeight - r - a),
                    (0 > s || o(u) > s) && (t.top += p + f + m))
                  : c > 0 &&
                    ((i =
                      t.top - e.collisionPosition.marginTop + p + f + m - l),
                    (i > 0 || c > o(i)) && (t.top += p + f + m));
              },
            },
            flipfit: {
              left: function () {
        ...
        function i(e, i) {
          ...
          for (s in i)
            (a = i[s]),
              e[s] !== a &&
                (n[s] ||
                  ((t.fx.step[s] || !isNaN(parseFloat(a))) && (o[s] = a)));
          return o;
        }
            ...
            t.extend(t.effects, {
              ...
              restore: function (t, e) {
                for (var i, s = 0, n = e.length; n > s; s++)
                  null !== e[s] && ((i = t.data(u + e[s])), t.css(e[s], i));
              },
    ...
    t.effects.define("blind", "hide", function (e, i) {
      ...
      t.effects.define("explode", "hide", function (e, i) {
        ...
        var a,
          ...
          b = [];
        for (a = 0; c > a; a++)
          for (l = g.top + a * y, u = a - (c - 1) / 2, o = 0; d > o; o++)
            (r = g.left + o * v),
              (h = o - (d - 1) / 2),
              p
                .clone()
      ...
      t.effects.define("fold", "hide", function (e, i) {
        var s = t(this),
          ...
          g = [p[u[0]], p[u[1]]],
          v = s.queue().length;
        l && (r = (parseInt(l[1], 10) / 100) * g[o ? 0 : 1]),
          (f.clip[u[0]] = r),
          (m.clip[u[0]] = r),
          (m.clip[u[1]] = 0),
          a &&
      ...
      t.effects.define("size", function (e, i) {
        var s,
          ...
          v = e.from || g,
          y = e.to || t.effects.scaledDimensions(o, 0);
        t.effects.createPlaceholder(o),
          "show" === u && ((a = v), (v = y), (y = a)),
          (n = {
          ...
          ("box" === d || "both" === d) &&
            (n.from.y !== n.to.y &&
              ((v = t.effects.setTransition(o, l, n.from.y, v)),
              (y = t.effects.setTransition(o, l, n.to.y, y))),
            n.from.x !== n.to.x &&
              ((v = t.effects.setTransition(o, h, n.from.x, v)),
              (y = t.effects.setTransition(o, h, n.to.x, y)))),
          ("content" === d || "both" === d) &&
            n.from.y !== n.to.y &&
            ((v = t.effects.setTransition(o, r, n.from.y, v)),
            (y = t.effects.setTransition(o, r, n.to.y, y))),
          p &&
          ...
          o.animate(y, {
            ...
            complete: function () {
              var e = o.offset();
              0 === y.opacity && o.css("opacity", v.opacity),
                c ||
      ...
      t.effects.define("pulsate", "show", function (e, i) {
        var s = t(this),
          ...
          d = s.queue().length;
        for (
          (a || !s.is(":visible")) && (s.css("opacity", 0).show(), (u = 1));
          l > c;
          c++
        )
          s.animate({ opacity: u }, h, e.easing), (u = 1 - u);
      ...
      t.effects.define("slide", "show", function (e, i) {
        var s,
          ...
          u = "up" === l || "left" === l,
          c = e.distance || a["top" === h ? "outerHeight" : "outerWidth"](!0),
          d = {};
        t.effects.createPlaceholder(a),
          (s = a.cssClip()),
          (n = a.position()[h]),
        ...
        _eventHandler: function (e) {
          ...
          e.preventDefault(),
            (r && !n.collapsible) ||
              ...
              ((n.active = !l && this.headers.index(o)),
              (this.active = r ? t() : o),
              this._toggle(c),
              this._removeClass(
                a,
      ...
      t.widget("ui.autocomplete", {
        ...
        _create: function () {
          var e,
            ...
            o = "input" === n;
          (this.isMultiLine =
            a || (!o && this._isContentEditable(this.element))),
              ...
              : void (
                  ...
                  e.element.find(n).each(function () {
                    ...
                    if ("button" !== s || !n.parent(".ui-spinner").length) {
                      a || (a = n[s]()[s]("instance")),
                        a &&
                          (r.classes = e._resolveClassesValues(r.classes, a)),
                        n[s](r);
                      var l = n[s]("widget");
                      t.data(
                        l[0],
    ...
    t.extend(s.prototype, {
            ...
            (i.trigger = t(
              this._get(i, "buttonImageOnly")
                ...
                : t("<button type='button'></button>")
                    .addClass(this._triggerClass)
                    .html(
                      a ? t("<img/>").attr({ src: a, alt: n, title: n }) : n
                    )
            )),
            ...
            a !== !1 &&
              ...
              s.inline ||
                ...
                t.effects && t.effects.effect[h]
                  ? s.dpDiv.show(h, t.datepicker._get(s, "showOptions"), u)
      ...
      parseDate: function (e, i, s) {
        ...
        if (
          ...
          for (g = 1, v = y; (a = this._getDaysInMonth(m, g - 1)), !(a >= v); )
            g++, (v -= a);
        if (
        ...
        for (
          t.drawMonth = J,
            ...
            i = V
              ? this.formatDate(
                  i,
                  this._daylightSavingAdjust(new Date(tt, J - G, 1)),
            ...
            n = V
              ...
              : n,
            a = this._canAdjustMonth(t, 1, tt, J)
            ...
            o = V ? this.formatDate(o, r, this._getFormatConfig(t)) : o,
            l = t.inline
              ? ""
          ...
          for (C = "", this.maxRows = 4, T = 0; X[1] > T; T++) {
            if (
              ((k = this._daylightSavingAdjust(new Date(tt, J, t.selectedDay))),
              (S = " ui-corner-all"),
              (D = ""),
              U)
            ) {
              if (((D += "<div class='ui-datepicker-group"), X[1] > 1))
                switch (T) {
                  case 0:
                    (D += " ui-datepicker-group-first"),
                      (S = " ui-corner-" + (q ? "right" : "left"));
                    break;
                  case X[1] - 1:
                    (D += " ui-datepicker-group-last"),
                      (S = " ui-corner-" + (q ? "left" : "right"));
                    break;
                  default:
            ...
            for (
              D +=
                ...
                S +
                "'>" +
                (/all|left/.test(S) && 0 === x ? (q ? a : s) : "") +
                (/all|right/.test(S) && 0 === x ? (q ? s : a) : "") +
            ...
            for (
              D += M + "</tr></thead><tbody>",
                ...
                z = (this._getFirstDayOfMonth(tt, J) - u + 7) % 7,
                E = Math.ceil((z + P) / 7),
                A = U && this.maxRows > E ? this.maxRows : E,
                this.maxRows = A,
                N = this._daylightSavingAdjust(new Date(tt, J, 1 - z)),
                H = 0;
              A > H;
              H++
            ) {
                ...
                (L = g ? g.apply(t.input ? t.input[0] : null, [N]) : [!0, ""]),
                  ...
                  (O +=
                    ...
                    ((N.getTime() === k.getTime() &&
                      J === t.selectedMonth &&
                      t._keyEvent) ||
                    (b.getTime() === N.getTime() && b.getTime() === k.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (R
    ...
    var y = (t.ui.intersect = (function () {
      ...
      return function (e, i, s, n) {
        ...
        switch (s) {
          ...
          case "touch":
            return (
              ((o >= u && d >= o) || (l >= u && d >= l) || (u > o && l > d)) &&
              ((a >= h && c >= a) || (r >= h && c >= r) || (h > a && r > c))
            );
          default:
            return !1;
        }
          ...
          t.each(
            ...
            function () {
              this.options &&
                (!this.options.disabled &&
                  this.visible &&
                  y(e, this, this.options.tolerance, i) &&
          ...
          t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              var s,
                n,
                a,
                o = y(e, this, this.options.tolerance, i),
                r =
                  !o && this.isover
                    ? "isout"
                    : o && !this.isover
              ...
              this.selectees.each(function () {
                ...
                i &&
                  ...
                  "touch" === n.tolerance
                    ...
                    : "fit" === n.tolerance &&
                      (h =
                        u.left > a && r > u.right && u.top > o && l > u.bottom),
                  h
                    ? (i.selected &&
      ...
      t.widget("ui.sortable", t.ui.mouse, {
        ...
        _refreshItems: function (e) {
          ...
          for (i = c.length - 1; i >= 0; i--)
            for (o = c[i][1], r = c[i][0], s = 0, h = r.length; h > s; s++)
              (l = t(r[s])),
      ...
      t.widget("ui.tabs", {
        ...
        _eventHandler: function (e) {
          var i = this.options,
            ...
            u = { oldTab: s, oldPanel: h, newTab: r ? t() : a, newPanel: l };
          e.preventDefault(),
  ...
  (function (t) {
    function e(e, i, s) {
      ...
      if (a) {
        ...
        if (
          !(
            (s.lock && o.is(":animated")) ||
            (s.onBefore && s.onBefore.call(s, e, a, o) === !1)
          )
        ) {
          if ((s.stop && o.stop(!0), s.hash)) {
            var r = a.id == n ? "id" : "name",
              l = t("<a> </a>")
                .attr(r, n)
                .css({
                  position: "absolute",
          ...
          o.scrollTo(a, s).trigger("notify.serialScroll", [a]);
        }
      }
    }
    ...
    (s.defaults = {
      ...
      (s.hash = function (i) {
        if (location.hash) {
          if (((i = t.extend({}, s.defaults, i)), (i.hash = !1), i.reset)) {
            var n = i.duration;
            delete i.duration, t(i.target).scrollTo(0, i), (i.duration = n);
          }
          e(0, location, i);
        }
      }),
      (t.fn.localScroll = function (n) {
        function a() {
          return (
            ...
            (!n.filter || t(this).is(n.filter))
          );
        }
        return (
          (n = t.extend({}, s.defaults, n)),
          n.lazy
            ? this.bind(n.event, function (i) {
                var s = t([i.target, i.target.parentNode]).filter(a)[0];
                s && e(i, s, n);
              })
            : this.find("a,area")
                .filter(a)
                .bind(n.event, function (t) {
                  e(t, this, n);
                })
                .end()
                .end()
    ...
    (o.version = "master"),
      ...
      (o._apply = function (e, i) {
        ...
        return (
          ...
          o._maintainScroll &&
            t(window).scrollTop((u / c) * t("html").outerHeight(!0)),
          this
        );
      }),
...
*/,
    ...
    (i.defaults = {
      ...
      (t.fn._scrollable = function () {
        return this.map(function () {
          ...
          return t.browser.safari || "BackCompat" == s.compatMode
            ? s.body
            : s.documentElement;
        });
      }),
      (t.fn.scrollTo = function (s, n, a) {
        return (
          "object" == typeof n && ((a = n), (n = 0)),
          "function" == typeof a && (a = { onAfter: a }),
          "max" == s && (s = 9e9),
          (a = t.extend({}, i.defaults, a)),
          (n = n || a.speed || a.duration),
            ...
            .each(function () {
              ...
              t.each(a.axis.split(""), function (t, e) {
                var s = "x" == e ? "Left" : "Top",
                  ...
                  m = i.max(l, e);
                if (r)
                  (c[p] = r[n] + (d ? 0 : f - h.offset()[n])),
                    a.margin &&
                      ((c[p] -= parseInt(u.css("margin" + s), 10) || 0),
                      (c[p] -= parseInt(u.css("border" + s + "Width")) || 0)),
                    (c[p] += a.offset[n] || 0),
                    a.over[n] &&
                      (c[p] += u["x" == e ? "width" : "height"]() * a.over[n]);
                else {
                  var g = u[n];
                  c[p] =
                    g.slice && "%" == g.slice(-1)
                ...
                /^\d+$/.test(c[p]) &&
                  (c[p] = c[p] <= 0 ? 0 : Math.min(c[p], m)),
                  !t &&
                    a.queue &&
                    (f != c[p] && o(a.onAfterFirst), delete c[p]);
              }),
                o(a.onAfter);
            })
            .end()
      ...
      (i.max = function (e, i) {
        ...
        return Math.max(o[n], r[n]) - Math.min(o[a], r[a]);
      });
  })(jQuery),
  (function (t, e, i, s) {
    (i.swipebox = function (n, a) {
      var o,
        r,
        l = {
          useCSS: !0,
      ...
      (h.settings = {}),
        ...
        (h.init = function () {
          (h.settings = i.extend({}, l, a)),
            i.isArray(n)
              ? ((u = n),
                (o.target = i(t)),
                o.init(h.settings.initialIndexOnArray))
              : i(e).on("click", c, function (t) {
                  if ("slide current" === t.target.parentNode.className)
                    return !1;
                  i.isArray(n) || (o.destroy(), (r = i(c)), o.actions()),
                    (u = []);
                  var e, s, a;
        ...
        (o = {
          init: function (t) {
            h.settings.beforeOpen && h.settings.beforeOpen(),
              ...
              this.preloadMedia(t - 1),
              h.settings.afterOpen && h.settings.afterOpen(t);
          },
          build: function () {
            var t,
              e = this;
            i("body").append(y),
              f &&
                h.settings.useSVG === !0 &&
                ((t = i("#swipebox-close").css("background-image")),
                (t = t.replace("png", "svg")),
                i("#swipebox-prev, #swipebox-next, #swipebox-close").css({
                  "background-image": t,
                })),
              d &&
                h.settings.removeBarsOnMobile &&
            ...
            "onorientationchange" in t
              ? t.addEventListener(
                  ...
                  function () {
                    0 === t.orientation
                      ? ((e = m), (s = g))
                      : (90 !== t.orientation && t.orientation !== -90) ||
                        ((e = g), (s = m));
                  },
                  !1
                )
              : ((e = t.innerWidth ? t.innerWidth : i(t).width()),
          ...
          supportTransition: function () {
            ...
            for (t = 0; t < i.length; t++)
              if (e.createElement("div").style[i[t]] !== s) return i[t];
            return !1;
          },
          doCssTrans: function () {
            if (h.settings.useCSS && this.supportTransition()) return !0;
          },
          gesture: function () {
            var t,
              e,
              ...
              i("body")
                .bind("touchstart", function (r) {
                  return (
                    ...
                    (f = r.originalEvent.targetTouches[0]),
                    (p.pageX = r.originalEvent.targetTouches[0].pageX),
                    (p.pageY = r.originalEvent.targetTouches[0].pageY),
                    ...
                    i(".touching").bind("touchmove", function (r) {
                      if (
                        ...
                        var g = 0.75 - Math.abs(s) / y.height();
                        y.css({ top: s + "px" }),
                          y.css({ opacity: g }),
                          (l = !0);
                      }
                ...
                .bind("touchend", function (t) {
                  if (
                    ...
                    if (
                      ((l = !1),
                      Math.abs(s) >= 2 * d && Math.abs(s) > Math.abs(a))
                    ) {
                      var u = s > 0 ? y.height() : -y.height();
                      y.animate(
                        { top: u + "px", opacity: 0 },
                        300,
                        function () {
                    ...
                    } else y.animate({ top: 0, opacity: 1 }, 300);
                  else
                    h
                      ? ((h = !1),
                        e >= c && e >= n
          ...
          animBars: function () {
            ...
            e.addClass("visible-bars"),
              ...
              i("#swipebox-bottom-bar").hover(
                ...
                function () {
                  h.settings.hideBarsDelay > 0 &&
                    (e.removeClass("visible-bars"), t.setTimeout());
                }
              );
          },
          keyboard: function () {
            ...
            i("html").addClass("swipebox-html"),
              p
                ? (i("html").addClass("swipebox-touch"),
                  h.settings.hideCloseButtonOnMobile &&
          ...
          openMedia: function (t) {
            ...
            return (
              u[t] !== s && (e = u[t].href),
              !(t < 0 || t >= u.length) &&
                ((n = i("#swipebox-slider .slide").eq(t)),
                void (a.isVideo(e)
                  ? (n.html(a.getVideo(e)),
                    h.settings.afterMedia && h.settings.afterMedia(t))
                  : (n.addClass("slide-loading"),
                    a.loadMedia(e, function () {
          ...
          parseUri: function (t, s) {
            ...
            return (
              ...
              i.isPlainObject(s) &&
                (a = i.extend(a, s, h.settings.queryStringData)),
              i
                .map(a, function (t, e) {
                  if (t && t > "")
          ...
          getVideo: function (t) {
            ...
            return (
              i || s
                ? (s && (i = s),
                  (a = o.parseUri(t, {
                    autoplay: h.settings.autoplayVideos ? "1" : "0",
                    v: "",
                  })),
                  (e =
            ...
            if (0 === t.trim().indexOf("#"))
              e.call(
                i("<div>", { class: "swipebox-inline-container" }).append(
                  i(t).clone().toggleClass(h.settings.toggleClassOnLoad)
                )
              );
          ...
          getNext: function () {
            ...
            s + 1 < u.length
              ? ((t = i("#swipebox-slider .slide")
                ...
                e.setSlide(s),
                e.preloadMedia(s + 1),
                h.settings.nextSlide && h.settings.nextSlide(s))
              : h.settings.loopAtEnd === !0
              ? ((t = i("#swipebox-slider .slide")
                  .eq(s)
                  .contents()
          ...
          getPrev: function () {
            ...
            e > 0
              ? ((t = i("#swipebox-slider .slide")
                ...
                h.settings.prevSlide && h.settings.prevSlide(e))
          ...
          destroy: function () {
            i(t).unbind("keyup"),
              ...
              (i.swipebox.isOpen = !1),
              h.settings.afterClose && h.settings.afterClose();
          },
        }),
        h.init();
    }),
        ...
        if (null != h && null != h.form) {
          ...
          return (
            ...
            o.required &&
              ((r = o.required),
              delete o.required,
              (o = t.extend({ required: r }, o)),
              t(h).attr("aria-required", "true")),
            o.remote &&
              ((r = o.remote),
              delete o.remote,
              (o = t.extend(o, { remote: r }))),
            o
          );
        }
      },
        ...
        prototype: {
          ...
          check: function (e) {
            ...
            if ("function" == typeof a.normalizer) {
              if (((l = a.normalizer.call(e, l)), "string" != typeof l))
                throw new TypeError(
            ...
            for (s in a) {
              ...
              try {
                if (
                  ((i = t.validator.methods[s].call(this, l, e, n.parameters)),
          ...
          showLabel: function (e, i) {
            ...
            r.length
              ? (r
                ...
                r.html(i))
              : ((r = t("<" + this.settings.errorElement + ">")
                  .attr("id", l + "-error")
                  .addClass(this.settings.errorClass)
                  .html(i || "")),
                (s = r),
          ...
          errorsFor: function (e) {
            ...
            return (
              s &&
                (n = n + ", #" + this.escapeCssMeta(s).replace(/\s+/g, ", #")),
      ...
      t.ajaxPrefilter
        ...
        : ((e = t.ajax),
          (t.ajax = function (s) {
            ...
            return "abort" === n
              ? (i[a] && i[a].abort(), (i[a] = e.apply(this, arguments)), i[a])
              : e.apply(this, arguments);
          })),
      t
    );
  ...
  (function (t, e, s, n) {
    function a(e, i) {
      ...
      var s = this.$el.data(),
        n = {};
      for (var a in s)
        if (s.hasOwnProperty(a) && a.match(/zs[A-Z]/)) {
          var l = a.substr(2);
          (l = l.charAt(0).toLowerCase() + l.slice(1)), (n[l] = s[a]);
        }
      return (
        (this.settings = t.extend({}, r, n, i)),
    ...
    t.extend(a.prototype, {
      init: function () {
        ...
        var i = this,
          s = t("<img />");
        s.load(function () {
          1 == i.numSlides ? i.initSingle() : i.initSlideshow();
        }),
          s.attr("src", this.settings.src[0]);
      },
      initSlideshow: function () {
        var e = this,
          s = t('<div class="zs-slideshow"></div>'),
          n = t('<div class="zs-slides"></div>'),
          a = t('<div class="zs-bullets"></div>');
        for (i = 0; i < this.numSlides; i++) {
          var o = t('<div class="zs-slide zs-slide-' + i + '"></div>');
          o.css({
            "background-image": "url('" + this.settings.src[i] + "')",
          }).appendTo(n);
          var r = t('<div class="zs-bullet zs-bullet-' + i + '"></div>');
          r.appendTo(a),
            0 == i &&
              (o.addClass("active").css("opacity", 1), r.addClass("active"));
        }
        if (
          (e._promoteChildren(),
          s.append(n).prependTo(this.$el),
          1 == this.settings.bullets &&
            (s.append(a),
            s.on("click", ".zs-bullet", function (i) {
              e.jump(t(this).index());
            })),
          (this.pos = 0),
          (this.pending = null),
          ...
          var l = this.$slides.eq(0);
          l.css("opacity", 0).css(this.transitionProp),
            setTimeout(function () {
              l.css({ opacity: 1, transform: "scale(1.0, 1.0)", "z-index": 2 });
            }, 50);
        }
      ...
      initSingle: function () {
        var e = this,
          i = t('<div class="zs-slideshow"></div>'),
          s = t('<div class="zs-slides"></div>'),
          n = t('<div class="zs-slide zs-slide-0"></div>');
        n
          .css({ "background-image": "url('" + this.settings.src[0] + "')" })
          .appendTo(s),
          n.addClass("active").css("opacity", 1),
          e._promoteChildren(),
          i.append(s).prependTo(this.$el),
          this.$el.addClass("zs-enabled"),
          "dots" == this.settings.overlay
            ? this.$el.addClass("overlay-dots")
            : "plain" == this.settings.overlay &&
      ...
      jump: function (t) {
        ...
        if (this.pos != t) {
          if (this.switching) return void (this.pending = t);
          var e = this,
            i = this.$slides.eq(this.pos),
            s = this.$slides.eq(t);
          this.support
            ? ((this.switching = !0),
              i.css("z-index", 1),
              s
                ...
                .on(this.transEndEventName, function (t) {
                  "opacity" == t.originalEvent.propertyName &&
                    ((lastSlideBg = i.css("background-image")),
                    i
                      .removeClass("active")
                      .removeAttr("style")
                      .css("background-image", lastSlideBg),
                    s.off(e.transEndEventName),
                    (e.switching = !1),
                    null != e.pending &&
                      setTimeout(function () {
                        var t = e.pending;
                        (e.pending = null), e.$bullets.eq(t).click();
                      }, 30));
                }))
            : (i.removeClass("active"), s.addClass("active")),
            this.$bullets.eq(this.pos).removeClass("active"),
            this.$bullets.eq(t).addClass("active"),
            (this.pos = t),
      ...
      prev: function () {
        var t = this.pos - 1;
        t < 0 && (t = this.numSlides - 1), this.jump(t);
      },
      next: function () {
        var t = this.pos + 1;
        t >= this.numSlides && (t = 0), this.jump(t);
      },
      play: function () {
      ...
      (t.fn[o] = function (e) {
        return this.each(function () {
          t.data(this, "plugin_" + o) ||
            t.data(this, "plugin_" + o, new a(this, e));
        });
      });
    var l = t("[data-zs-src]");
    l.length > 0 &&
    ...
    function i(t) {
      ...
      function n(e, i) {
        t.fn[e] = function (n) {
          if ("string" == typeof n) {
            for (
              var o = s.call(arguments, 1), r = 0, l = this.length;
              l > r;
              r++
            ) {
              var h = this[r],
              ...
              if (u)
                ...
                } else a("no such method '" + n + "' for " + e + " instance");
              else
                a(
                  "cannot call methods on " +
                    e +
  ...
  (function (t) {
    ...
    var a = { bind: s, unbind: n };
    "function" == typeof define && define.amd
      ? define("eventie/eventie", a)
      : "object" == typeof exports
      ? (module.exports = a)
      : (t.eventie = a);
  })(window),
    ...
    (s.getListeners = function (t) {
      ...
      (s.addListener = function (t, i) {
        ...
        for (s in n)
          n.hasOwnProperty(s) &&
            -1 === e(n[s], i) &&
            n[s].push(a ? i : { listener: i, once: !1 });
        return this;
      }),
      (s.on = i("addListener")),
      ...
      (s.manipulateListeners = function (t, e, i) {
        ...
        if ("object" != typeof e || e instanceof RegExp)
          for (s = i.length; s--; ) a.call(this, e, i[s]);
        else
          for (s in e)
            e.hasOwnProperty(s) &&
              (n = e[s]) &&
  ...
  (function (t) {
    function e(t) {
      if (t) {
        ...
        for (var e, n = 0, a = i.length; a > n; n++)
      ...
      function n() {
        if (!d) {
          ...
          if (
            ...
            o.appendChild(n);
            var r = h(n);
            (c = 200 === e(r.width)), o.removeChild(n);
          }
        }
      }
      function r(t) {
        if (
          ...
          for (
            var r = (a.isBorderBox = !(!u || !i[u] || "border-box" !== i[u])),
              d = 0,
              p = o.length;
            p > d;
            d++
          ...
          var v = a.paddingLeft + a.paddingRight,
            ...
            C = r && c,
            T = e(i.width);
          T !== !1 && (a.width = T + (C ? 0 : v + w));
          var k = e(i.height);
          return (
            k !== !1 && (a.height = k + (C ? 0 : y + x)),
            (a.innerWidth = a.width - (v + w)),
            (a.innerHeight = a.height - (y + x)),
            (a.outerWidth = a.width + b),
    ...
    function n(n) {
      return (
        "complete" === a.readyState
          ? s()
          : (n.bind(a, "DOMContentLoaded", i),
            n.bind(a, "readystatechange", i),
            n.bind(t, "load", i)),
        e
      );
    }
  ...
  (function (t) {
    ...
    function s(t, e) {
      i(t);
      for (
        var s = t.parentNode.querySelectorAll(e), n = 0, a = s.length;
        a > n;
        n++
      )
        if (s[n] === t) return !0;
    ...
    var a,
      o = (function () {
        ...
        for (
          var e = ["webkit", "moz", "ms", "o"], i = 0, s = e.length;
          s > i;
          i++
        ) {
          var n = e[i],
        ...
        for (var n = [], a = 0, o = t.length; o > a; a++) {
          ...
          if (s.isElement(r))
            if (e) {
              i(r, e) && n.push(r);
              for (
                var l = r.querySelectorAll(e), h = 0, u = l.length;
                u > h;
                h++
              )
                n.push(l[h]);
  ...
  (function (t, e) {
    ...
    n.extend(o.prototype, e.prototype),
      ...
      (o.prototype.getPosition = function () {
        var t = h(this.element),
          ...
          l =
            -1 != a.indexOf("%")
              ? (parseFloat(a) / 100) * o.height
              : parseInt(a, 10);
        (r = isNaN(r) ? 0 : r),
          (l = isNaN(l) ? 0 : l),
          (r -= i ? o.paddingLeft : o.paddingRight),
          (l -= s ? o.paddingTop : o.paddingBottom),
          (this.position.x = r),
          (this.position.y = l);
      }),
      ...
      (o.prototype.moveTo = d ? o.prototype._transitionTo : o.prototype.goTo),
    ...
    (o.prototype.enableTransition = function () {
      ...
      (o.prototype.transition =
        o.prototype[u ? "_transition" : "_nonTransition"]),
    ...
    (o.prototype.ontransitionend = function (t) {
      if (t.target === this.element) {
        ...
        if (
          ...
          a(e.ingProperties) && this.disableTransition(),
          i in e.clean &&
  ...
  (function (t, e) {
    ...
    return (
      ...
      n.extend(o.prototype, i.prototype),
      ...
      (o.prototype._getMeasurement = function (t, e) {
        ...
        a
          ? ("string" == typeof a
              ? (i = this.element.querySelector(a))
              : n.isElement(a) && (i = a),
            (this[t] = i ? s(i)[e] : a))
          : (this[t] = 0);
      }),
      ...
      (o.prototype._positionItem = function (t, e, i, s) {
      ...
      (o.create = function (t, e) {
        ...
        return (
          Object.create
            ...
            : n.extend(i.prototype, o.prototype),
  ...
  (function (t, e) {
    ...
    return (
      ...
      (s.prototype._getItemLayoutPosition = function (t) {
        ...
        for (
          var a = this._getColGroup(n),
            o = Math.min.apply(Math, a),
            r = i.indexOf(a, o),
            l = { x: this.columnWidth * r, y: o },
            h = o + t.size.outerHeight,
            u = this.cols + 1 - a.length,
            c = 0;
          u > c;
          c++
        )
      ...
      (s.prototype._manageStamp = function (t) {
        ...
        for (
          var l = (this.options.isOriginTop ? s.top : s.bottom) + i.outerHeight,
            h = o;
          r >= h;
          h++
        )
   ...
   */ (function () {
      ...
      i = function (t, s) {
        ...
        function a() {
          ...
          e.attr("data-swiper-autoplay") &&
            (t = e.attr("data-swiper-autoplay") || w.params.autoplay),
          ...
          if (
            ...
            if (37 === e || 39 === e || 38 === e || 40 === e) {
              ...
              if (
                ...
                0 ===
                  w.container.parents("." + w.params.slideActiveClass).length
              )
                return;
        ...
        function u(t) {
          ...
          if (0 !== e) {
            if ((w.params.mousewheelInvert && (e = -e), w.params.freeMode)) {
              var n =
                  w.getWrapperTranslate() + e * w.params.mousewheelSensitivity,
                a = w.isBeginning,
                o = w.isEnd;
              if (
                ...
                w.updateProgress(),
                w.updateActiveIndex(),
                ((!a && w.isBeginning) || (!o && w.isEnd)) && w.updateClasses(),
        ...
        function c(t) {
          ...
          return (
            ...
            "axis" in t && t.axis === t.HORIZONTAL_AXIS && ((n = a), (a = 0)),
            (o = n * e),
            (r = a * e),
            ...
            (o || r) &&
              t.deltaMode &&
              (1 === t.deltaMode ? ((o *= i), (r *= i)) : ((o *= s), (r *= s))),
            o && !n && (n = o < 1 ? -1 : 1),
            r && !a && (a = r < 1 ? -1 : 1),
            { spinX: n, spinY: a, pixelX: o, pixelY: r }
          );
        }
        function d(t, i) {
          t = e(t);
          ...
          (s = t.attr("data-swiper-parallax") || "0"),
            ...
            t.transform("translate3d(" + n + ", " + a + ",0px)");
        }
        function p(t) {
          return (
            0 !== t.indexOf("on") &&
        ...
        for (var b in f)
          if ("undefined" == typeof s[b]) s[b] = f[b];
            ...
            for (var _ in f[b])
              "undefined" == typeof s[b][_] && (s[b][_] = f[b][_]);
        var w = this;
        if (
          ((w.params = s),
          (w.originalParams = g),
          ...
          ("undefined" != typeof e ||
            ...
            (w.getActiveBreakpoint = function () {
              ...
              for (var s = 0; s < i.length; s++)
                (t = i[s]), t >= window.innerWidth && !e && (e = t);
              return e || "max";
            }),
          ...
          (w.container[0].swiper = w),
            ...
            w.support.flexbox ||
              (w.classNames.push(
                w.params.containerModifierClass + "no-flexbox"
              ),
            ...
            ("fade" !== w.params.effect && "flip" !== w.params.effect) ||
              ...
              (w.params.spaceBetween = 0),
              (w.params.setWrapperSize = !1),
              "undefined" == typeof m && (w.params.virtualTranslate = !0)),
            w.params.grabCursor &&
              w.support.touch &&
            ...
            (w.imagesToLoad = []),
            (w.imagesLoaded = 0),
            (w.loadImage = function (t, e, i, s, n, a) {
              function o() {
                a && a();
              }
              var r;
            ...
            (w.preloadImages = function () {
              ...
              for (var e = 0; e < w.imagesToLoad.length; e++)
                w.loadImage(
                  ...
                  w.imagesToLoad[e].sizes ||
                    w.imagesToLoad[e].getAttribute("sizes"),
                  !0,
                  t
                );
            }),
            ...
            (w.startAutoplay = function () {
              return (
                "undefined" == typeof w.autoplayTimeoutId &&
                !!w.params.autoplay &&
                !w.autoplaying &&
                ((w.autoplaying = !0), w.emit("onAutoplayStart", w), void a())
              );
            }),
            ...
            (w.updateAutoHeight = function () {
              ...
              if (
                ...
                for (t = 0; t < Math.ceil(w.params.slidesPerView); t++) {
                  var s = w.activeIndex + t;
                  if (s > w.slides.length) break;
                  e.push(w.slides.eq(s)[0]);
                }
            ...
            (w.updateSlidesSize = function () {
              ...
              if ("undefined" != typeof w.size) {
                ...
                var r,
                  ...
                  h = o / l,
                  u = h - (w.params.slidesPerColumn * h - w.slides.length);
                  ...
                  "none" !== c.css("display") &&
                    ("auto" === w.params.slidesPerView
                      ? ((r = w.isHorizontal()
                          ? c.outerWidth(!0)
                          : c.outerHeight(!0)),
                        w.params.roundLengths && (r = n(r)))
                      : ((r =
                          (w.size - (w.params.slidesPerView - 1) * e) /
                          w.params.slidesPerView),
                        w.params.roundLengths && (r = n(r)),
                        w.isHorizontal()
                          ? (w.slides[t].style.width = r + "px")
                          : (w.slides[t].style.height = r + "px")),
                    (w.slides[t].swiperSlideSize = r),
                ...
                if (
                  ...
                  w.params.slidesPerColumn > 1 &&
                    ((w.virtualSize = (r + w.params.spaceBetween) * o),
                    (w.virtualSize =
            ...
            (w.currentSlidesPerView = function () {
              ...
              if (w.params.centeredSlides) {
                ...
                for (t = w.activeIndex + 1; t < w.slides.length; t++)
                  w.slides[t] &&
                    !s &&
                    ((n += w.slides[t].swiperSlideSize),
                    i++,
                    n > w.size && (s = !0));
                for (e = w.activeIndex - 1; e >= 0; e--)
                  w.slides[e] &&
                    !s &&
                    ((n += w.slides[e].swiperSlideSize),
                    i++,
                    n > w.size && (s = !0));
              } else
                for (t = w.activeIndex + 1; t < w.slides.length; t++)
              ...
              if (
                ...
                for (var i = 0; i < w.slides.length; i++) {
                  ...
                  if (w.params.watchSlidesVisibility) {
                    var a = -(e - s.swiperSlideOffset),
                      o = a + w.slidesSizesGrid[i],
                      r =
                        (a >= 0 && a < w.size) ||
                        (o > 0 && o <= w.size) ||
                        (a <= 0 && o >= w.size);
            ...
            (w.updateActiveIndex = function () {
              ...
              for (e = 0; e < w.slidesGrid.length; e++)
                "undefined" != typeof w.slidesGrid[e + 1]
                  ? s >= w.slidesGrid[e] &&
                    s <
                      w.slidesGrid[e + 1] -
                ...
                w.updateClasses(),
                  (s =
                    ...
                    !w.params.centeredSlides
                      ? w.slideTo(w.slides.length - 1, 0, !1, !0)
                      : w.slideTo(w.activeIndex, 0, !1, !0));
              w.params.lazyLoading && !s && w.lazy && w.lazy.load(),
            ...
            (w.initEvents = function (t) {
              ...
              if (w.browser.ie)
                n[i](w.touchEvents.start, w.onTouchStart, !1),
                  a[i](w.touchEvents.move, w.onTouchMove, o),
                ...
                if (w.support.touch) {
                  ...
                  n[i](w.touchEvents.start, w.onTouchStart, r),
                    n[i](w.touchEvents.move, w.onTouchMove, o),
                    n[i](w.touchEvents.end, w.onTouchEnd, r);
                }
                ((s.simulateTouch && !w.device.ios && !w.device.android) ||
                  (s.simulateTouch && !w.support.touch && w.device.ios)) &&
                  (n[i]("mousedown", w.onTouchStart, !1),
                  document[i]("mousemove", w.onTouchMove, o),
              ...
              if (
                ...
                if (w.params.loop) {
                  ...
                  (a = parseInt(
                    ...
                    w.params.centeredSlides
                      ? r < w.loopedSlides - l / 2 ||
                        r > w.slides.length - w.loopedSlides + l / 2
                        ? (w.fixLoop(),
                          (r = w.wrapper
                            .children(
                              "." +
          ...
          (w.onTouchStart = function (t) {
            ...
            (w.onTouchMove = function (t) {
              if (
                ...
                if (O && w.params.touchReleaseOnEdges && !w.params.loop)
                  if (w.isHorizontal()) {
                    if (
                ...
                if (
                  ...
                  if (
                    (D && w.emit("onTouchMoveOpposite", w, t),
                    "undefined" == typeof L &&
                      w.browser.ieTouch &&
                      ((w.touches.currentX === w.touches.startX &&
                        w.touches.currentY === w.touches.startY) ||
                    ...
                    if (L || !w.browser.ieTouch) {
                      ...
                      if (
                        ...
                        if (!(Math.abs(n) > w.params.threshold || P))
                          return void (M = I);
                        if (!P)
                          return (
                            (P = !0),
              ...
              if (
                ...
                if (
                  (w.allowClick &&
                    ...
                    s < 300 &&
                      i - N < 300 &&
                      (z && clearTimeout(z), w.emit("onDoubleTap", w, t))),
                  (N = Date.now()),
                  setTimeout(function () {
                    w && (w.allowClick = !0);
                  }, 0),
                ...
                if (
                  ...
                  if (w.params.freeModeMomentum) {
                    ...
                    (w.velocity =
                      ...
                      (H.length = 0);
                    var h = 1e3 * w.params.freeModeMomentumRatio,
                      u = w.velocity * h,
                      c = w.translate + u;
                    w.rtl && (c = -c);
                    var d,
                ...
                for (
                  ...
                  typeof w.slidesGrid[v + w.params.slidesPerGroup]
                    ? n >= w.slidesGrid[v] &&
                      n < w.slidesGrid[v + w.params.slidesPerGroup] &&
                      ((y = v),
                      (b =
            ...
            (w.slideTo = function (t, e, i, s) {
              ...
              if (
                ...
                for (var a = 0; a < w.slidesGrid.length; a++)
                  -Math.floor(100 * n) >= Math.floor(100 * w.slidesGrid[a]) &&
                    (t = a);
              return (
                !(
                  !w.params.allowSwipeToNext &&
            ...
            (w.setWrapperTranslate = function (t, e, i) {
              var s = 0,
                a = 0,
                o = 0;
              w.isHorizontal() ? (s = w.rtl ? -t : t) : (a = t),
                w.params.roundLengths && ((s = n(s)), (a = n(a))),
                w.params.virtualTranslate ||
                  (w.support.transforms3d
                    ? w.wrapper.transform(
                        "translate3d(" + s + "px, " + a + "px, " + o + "px)"
                      )
                    : w.wrapper.transform(
                        "translate(" + s + "px, " + a + "px)"
                      )),
                (w.translate = w.isHorizontal() ? s : a);
              var r,
                l = w.maxTranslate() - w.minTranslate();
              (r = 0 === l ? 0 : (t - w.minTranslate()) / l),
                      ...
                      ? ((s = n.transform || n.webkitTransform),
                        s.split(",").length > 6 &&
                          (s = s
                            ...
                            .join(", ")),
                        (a = new window.WebKitCSSMatrix("none" === s ? "" : s)))
                      : ((a =
                          n.MozTransform ||
                          n.OTransform ||
                          n.MsTransform ||
            ...
            (w.getWrapperTranslate = function (t) {
              return (
                "undefined" == typeof t && (t = w.isHorizontal() ? "x" : "y"),
            ...
            (w.initObservers = function () {
              if (w.params.observeParents)
                for (var t = w.container.parents(), e = 0; e < t.length; e++)
                  r(t[e]);
              r(w.container[0], { childList: !1 }),
                r(w.wrapper[0], { attributes: !1 });
            }),
            ...
            (w.createLoop = function () {
              ...
              for (
                t.each(function (i, a) {
                  var o = e(this);
                  i < w.loopedSlides && n.push(a),
                    i < t.length && i >= t.length - w.loopedSlides && s.push(a),
              ...
              for (i = s.length - 1; i >= 0; i--)
                w.wrapper.prepend(
                  e(s[i].cloneNode(!0)).addClass(w.params.slideDuplicateClass)
                );
            }),
                  ...
                  for (var t = 0; t < w.slides.length; t++) {
                    ...
                    if (
                      (w.isHorizontal()
                        ...
                        : ((h = l), (l = 0), (r = -o), (o = 0)),
                      (i[0].style.zIndex =
                        -Math.abs(Math.round(s)) + w.slides.length),
                ...
                setTranslate: function () {
                  ...
                  for (var s = 0; s < w.slides.length; s++) {
                    ...
                    s % 4 === 0
                      ...
                      ? ((l = 0), (u = 4 * -o * w.size))
                      : (s - 2) % 4 === 0
                      ? ((l = w.size + 4 * o * w.size), (u = w.size))
                      : (s - 3) % 4 === 0 &&
                        ((l = -w.size), (u = 3 * w.size + 4 * w.size * o)),
                      w.rtl && (l = -l),
                      w.isHorizontal() || ((h = l), (l = 0));
                    var c =
                      "rotateX(" +
                      (w.isHorizontal() ? 0 : -a) +
                      "deg) rotateY(" +
                ...
                setTranslate: function () {
                  for (
                    ...
                    var r = w.slides.eq(a),
                      ...
                      u = ((i - h - l / 2) / l) * w.params.coverflow.modifier,
                      c = w.isHorizontal() ? s * u : 0,
                      d = w.isHorizontal() ? 0 : s * u,
                      p = -n * Math.abs(u),
                    ...
                    if (
                      (r.transform(g),
                      (r[0].style.zIndex = -Math.abs(Math.round(u)) + 1),
            ...
            (w.lazy = {
              ...
              loadImageInSlide: function (t, i) {
                if (
                  ...
                  !s.hasClass(w.params.lazyLoadingClass) ||
                    s.hasClass(w.params.lazyStatusLoadedClass) ||
                    s.hasClass(w.params.lazyStatusLoadingClass) ||
                    (n = n.add(s[0])),
                    0 !== n.length &&
                      n.each(function () {
                        var t = e(this);
                        ...
                        var n = t.attr("data-background"),
                          ...
                          r = t.attr("data-sizes");
                        w.loadImage(t[0], a || n, o, r, !1, function () {
                          if (
                            (n
                            ...
                            if (s.hasClass(w.params.slideDuplicateClass)) {
                              ...
                              w.lazy.loadImageInSlide(h.index(), !1);
                            }
                          }
              ...
              load: function () {
                ...
                if (w.params.lazyLoadingInPrevNext)
                  if (
                    ...
                    var s = w.params.lazyLoadingInPrevNextAmount,
                      n = i,
                      a = Math.min(
                        w.activeIndex + n + Math.max(s, n),
                        w.slides.length
                      ),
                      o = Math.max(w.activeIndex - Math.max(n, s), 0);
                    for (t = w.activeIndex + i; t < a; t++)
                      w.slides[t] && w.lazy.loadImageInSlide(t);
                    for (t = o; t < w.activeIndex; t++)
                      w.slides[t] && w.lazy.loadImageInSlide(t);
                  } else {
              ...
              setDragPosition: function (t) {
                var e = w.scrollbar,
                  ...
                  s =
                    ...
                    e.dragSize / 2,
                  n = -w.minTranslate() * e.moveDivider,
                  a = -w.maxTranslate() * e.moveDivider;
                s < n ? (s = n) : s > a && (s = a),
                  (s = -s / e.moveDivider),
                  w.updateProgress(s),
                  w.setWrapperTranslate(s, !0);
              },
                ...
                function s(e) {
                  (t =
                    ...
                    "slide" === w.params.controlBy &&
                      ...
                      (a = -w.controller.spline.interpolate(-t))),
                    (a && "container" !== w.params.controlBy) ||
                      ((n =
                        (e.maxTranslate() - e.minTranslate()) /
                        (w.maxTranslate() - w.minTranslate())),
                      (a = (t - w.minTranslate()) * n + e.minTranslate())),
                    w.params.controlInverse && (a = e.maxTranslate() - a),
                    e.updateProgress(a),
                    e.setWrapperTranslate(a, !1, w),
                    e.updateActiveIndex();
                }
                var n,
                  a,
              ...
              setTransition: function (t, e) {
                ...
                if (w.isArray(a))
                  for (n = 0; n < a.length; n++)
                    a[n] !== e && a[n] instanceof i && s(a[n]);
                else a instanceof i && e !== a && s(a);
              },
            }),
            (w.hashnav = {
              onHashCange: function (t, e) {
                var i = document.location.hash.replace("#", ""),
                  s = w.slides.eq(w.activeIndex).attr("data-hash");
                i !== s &&
                  w.slideTo(
                    w.wrapper
                      .children(
              ...
              init: function () {
                if (w.params.hashnav && !w.params.history) {
                  ...
                  if (t)
                    for (var e = 0, i = 0, s = w.slides.length; i < s; i++) {
                      var n = w.slides.eq(i),
            ...
            (w.history = {
              init: function () {
                if (w.params.history) {
                  if (!window.history || !window.history.pushState)
                    return (
                      (w.params.history = !1), void (w.params.hashnav = !0)
                    );
              ...
              setHistory: function (t, e) {
                if (w.history.initialized && w.params.history) {
                  ...
                  window.location.pathname.includes(t) || (s = t + "/" + s),
                    w.params.replaceState
              ...
              scrollToSlide: function (t, e, i) {
                if (e)
                  for (var s = 0, n = w.slides.length; s < n; s++) {
                    var a = w.slides.eq(s),
                      o = this.slugify(a.attr("data-history"));
                    if (o === e && !a.hasClass(w.params.slideDuplicateClass)) {
                      var r = a.index();
                      w.slideTo(r, t, i);
                    }
                  }
            ...
            (w.zoom = {
              ...
              getDistanceBetweenTouches: function (t) {
                ...
                var e = t.targetTouches[0].pageX,
                  ...
                  a = Math.sqrt(Math.pow(s - e, 2) + Math.pow(n - i, 2));
                return a;
              },
              ...
              onGestureChange: function (t) {
                ...
                e.gesture.image &&
                  ...
                  e.scale < w.params.zoomMin &&
                    (e.scale =
                      w.params.zoomMin +
                      1 -
                      Math.pow(w.params.zoomMin - e.scale + 1, 0.5)),
              ...
              onTouchMove: function (t) {
                ...
                if (
                  e.gesture.image &&
                  0 !== e.gesture.image.length &&
                  ((w.allowClick = !1), e.image.isTouched && e.gesture.slide)
                ) {
                  e.image.isMoved ||
                    ((e.image.width = e.gesture.image[0].offsetWidth),
                    (e.image.height = e.gesture.image[0].offsetHeight),
                    (e.image.startX =
                      w.getTranslate(e.gesture.imageWrap[0], "x") || 0),
                    (e.image.startY =
                      w.getTranslate(e.gesture.imageWrap[0], "y") || 0),
                  ...
                  if (
                    !(i < e.gesture.slideWidth && s < e.gesture.slideHeight)
                  ) {
                    if (
              ...
              onTouchEnd: function (t, e) {
                ...
                if (i.gesture.image && 0 !== i.gesture.image.length) {
                  ...
                  var s = 300,
                    n = 300,
                    a = i.velocity.x * s,
                    o = i.image.currentX + a,
                    r = i.velocity.y * n,
                    l = i.image.currentY + r;
                  0 !== i.velocity.x &&
                    (s = Math.abs((o - i.image.currentX) / i.velocity.x)),
                    0 !== i.velocity.y &&
                      (n = Math.abs((l - i.image.currentY) / i.velocity.y));
                  var h = Math.max(s, n);
                  (i.image.currentX = o), (i.image.currentY = l);
                  var u = i.image.width * i.scale,
                    c = i.image.height * i.scale;
                  (i.image.minX = Math.min(
                    i.gesture.slideWidth / 2 - u / 2,
                    0
                  )),
              ...
              toggleZoom: function (t, i) {
                ...
                if (
                  (s.gesture.slide ||
                    ((s.gesture.slide = t.clickedSlide
                      ? e(t.clickedSlide)
                      : t.slides.eq(t.activeIndex)),
                    (s.gesture.image =
                      s.gesture.slide.find("img, svg, canvas")),
                    (s.gesture.imageWrap = s.gesture.image.parent(
                      "." + t.params.zoomContainerClass
                    ))),
                  s.gesture.image && 0 !== s.gesture.image.length)
                ) {
                  var n, a, o, r, l, h, u, c, d, p, f, m, g, v, y, b, _, w;
                  "undefined" == typeof s.image.touchesStart.x && i
                    ? ((n =
                        "touchend" === i.type
                      ...
                      (a =
                        "touchend" === i.type
                          ...
                          : i.pageY))
                    : ((n = s.image.touchesStart.x),
                      (a = s.image.touchesStart.y)),
                    s.scale && 1 !== s.scale
                      ...
                      : ((s.scale = s.currentScale =
                          ...
                          t.params.zoomMax),
                        i
                          ? ((_ = s.gesture.slide[0].offsetWidth),
                            (w = s.gesture.slide[0].offsetHeight),
                            (o = s.gesture.slide.offset().left),
                            (r = s.gesture.slide.offset().top),
                            (l = o + _ / 2 - n),
                            (h = r + w / 2 - a),
                            (d = s.gesture.image[0].offsetWidth),
                            (p = s.gesture.image[0].offsetHeight),
                            (f = d * s.scale),
                            (m = p * s.scale),
                            (g = Math.min(_ / 2 - f / 2, 0)),
                            (v = Math.min(w / 2 - m / 2, 0)),
                            (y = -g),
                            (b = -v),
                            (u = l * s.scale),
                            (c = h * s.scale),
                        ...
                        s.gesture.imageWrap
                          .transition(300)
                          .transform("translate3d(" + u + "px, " + c + "px,0)"),
                        s.gesture.image
                          .transition(300)
                          .transform(
              ...
              attachEvents: function (t) {
                ...
                if (w.params.zoom) {
                  ...
                  w.support.gestures
                    ? (w.slides[i]("gesturestart", w.zoom.onGestureStart, s),
                      w.slides[i]("gesturechange", w.zoom.onGestureChange, s),
                      w.slides[i]("gestureend", w.zoom.onGestureEnd, s))
                    : "touchstart" === w.touchEvents.start &&
                      (w.slides[i](
                        w.touchEvents.start,
                      ...
                      w.slides[i](
                        w.touchEvents.move,
                        w.zoom.onGestureChange,
                        s
                      ),
                      w.slides[i](w.touchEvents.end, w.zoom.onGestureEnd, s)),
                    w[i]("touchStart", w.zoom.onTouchStart),
                    w.slides.each(function (t, s) {
                      e(s).find("." + w.params.zoomContainerClass).length > 0 &&
                        e(s)[i](w.touchEvents.move, w.zoom.onTouchMove);
                    }),
    ...
    for (var s = ["jQuery", "Zepto", "Dom7"], n = 0; n < s.length; n++)
      window[s[n]] && t(window[s[n]]);
    var a;
    (a =
      "undefined" == typeof Dom7
        ? window.Dom7 || window.Zepto || window.jQuery
      ...
      a &&
        ("transitionEnd" in a.fn ||
          (a.fn.transitionEnd = function (t) {
            function e(a) {
              if (a.target === this)
                for (t.call(this, a), i = 0; i < s.length; i++) n.off(s[i], e);
            }
            var i,
              s = [
                "webkitTransitionEnd",
              ...
              n = this;
            if (t) for (i = 0; i < s.length; i++) n.on(s[i], e);
            return this;
          }),
        "transform" in a.fn ||
