...
class review extends MX_Controller {
	...
	public function header_new($display_html = true){
		...
		$this->load->view('blocks/header_new', $data);
	...
	public function footer_new($display_html = true){
		...
		$this->load->view('blocks/footer_new', $data);
